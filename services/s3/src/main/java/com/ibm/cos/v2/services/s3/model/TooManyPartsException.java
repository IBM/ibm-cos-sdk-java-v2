...
public final class TooManyPartsException extends S3Exception implements
        ToCopyableBuilder<TooManyPartsException.Builder, TooManyPartsException> {
    ...
    private TooManyPartsException(BuilderImpl builder) {
        super(builder);
    }
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, TooManyPartsException>, S3Exception.Builder {
        @Override
    ...
    static final class BuilderImpl extends S3Exception.BuilderImpl implements Builder {
        ...
        private BuilderImpl(TooManyPartsException model) {
            super(model);
        }
        ...
        @Override
        public TooManyPartsException build() {
            return new TooManyPartsException(this);
        }
