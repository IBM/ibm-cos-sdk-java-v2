...
public final class CreateBucketRequest extends S3Request implements
    ...
    /** IBM Specific: The encryptionType of S3 bucket to create. */
     ...
     * </p>
     * <p>
     * <b>General purpose buckets</b> - For information about bucket naming restrictions, see <a
     * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html">Bucket naming rules</a> in
     ...
     * </p>
     * 
     * @return The name of the bucket to create.</p>
     *         <p>
     *         <b>General purpose buckets</b> - For information about bucket naming restrictions, see <a
    ...
    public final String toString() {
        return ToString.builder("CreateBucketRequest").add("ACL", aclAsString()).add("Bucket", bucket())
                ...
                .add("ObjectOwnership", objectOwnershipAsString())
                .add("EncryptionType", encryptionType())
                .add("ServiceInstanceId",serviceInstanceId()).build();
    }
    ...
    public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
        ...
        case "ServiceInstanceId" :
            return Optional.ofNullable((clazz.cast(serviceInstanceId())));
        default:
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("CreateBucketConfiguration", CREATE_BUCKET_CONFIGURATION_FIELD);
        ...
        map.put("x-amz-grant-write", GRANT_WRITE_FIELD);
        map.put("x-amz-grant-write-acp", GRANT_WRITE_ACP_FIELD);
        map.put("x-amz-bucket-object-lock-enabled", OBJECT_LOCK_ENABLED_FOR_BUCKET_FIELD);
        map.put("x-amz-object-ownership", OBJECT_OWNERSHIP_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, CreateBucketRequest> {
         ...
         * 
         * @param bucket
         *        The name of the bucket to create.</p>
         *        <p>
         *        <b>General purpose buckets</b> - For information about bucket naming restrictions, see <a
         *        href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html">Bucket naming
         *        rules</a> in the <i>Amazon S3 User Guide</i>.
         ...
         ** @return Returns a reference to this object so that method calls can be chained together
         * @see CreateBucketRequest#encryptionType()
         */
         ...
         *        The new value for the IBM service instance Id property for this object.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
    ...
    static final class BuilderImpl extends S3Request.BuilderImpl implements Builder {
        ...
        private BuilderImpl(CreateBucketRequest model) {
            ...
            serviceInstanceId(model.serviceInstanceId);
        }
