...
public final class InvalidWriteOffsetException extends S3Exception implements
        ToCopyableBuilder<InvalidWriteOffsetException.Builder, InvalidWriteOffsetException> {
    ...
    private InvalidWriteOffsetException(BuilderImpl builder) {
        super(builder);
    }
    ...
    static final class BuilderImpl extends S3Exception.BuilderImpl implements Builder {
        ...
        private BuilderImpl(InvalidWriteOffsetException model) {
            super(model);
        }
        ...
        @Override
        public InvalidWriteOffsetException build() {
