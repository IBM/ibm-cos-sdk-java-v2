...
public final class DeleteBucketEncryptionRequest extends S3Request implements
     ...
     * </p>
     * 
     * @return The name of the bucket containing the server-side encryption configuration to delete.</p>
     *         <p>
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketEncryptionRequest> {
         ...
         * 
         * @param bucket
         *        The name of the bucket containing the server-side encryption configuration to delete.</p>
         *        <p>
