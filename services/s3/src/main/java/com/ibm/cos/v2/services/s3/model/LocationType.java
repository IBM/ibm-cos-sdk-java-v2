...
public enum LocationType {
    ...
    private static final Map<String, LocationType> VALUE_MAP = EnumUtils.uniqueIndex(LocationType.class, LocationType::toString);
     ...
     *
     * @return a {@link Set} of known {@link LocationType}s
     */
    public static Set<LocationType> knownValues() {
        Set<LocationType> knownValues = EnumSet.allOf(LocationType.class);
