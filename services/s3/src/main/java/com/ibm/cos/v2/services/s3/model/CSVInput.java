...
public final class CSVInput implements SdkPojo, Serializable, ToCopyableBuilder<CSVInput.Builder, CSVInput> {
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("AllowQuotedRecordDelimiter", ALLOW_QUOTED_RECORD_DELIMITER_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, CSVInput> {
         ...
         * of that row. You can specify any character to indicate a comment line. The default character is
         * <code>#</code>.
         * </p>
         * <p>
         * Default: <code>#</code>
