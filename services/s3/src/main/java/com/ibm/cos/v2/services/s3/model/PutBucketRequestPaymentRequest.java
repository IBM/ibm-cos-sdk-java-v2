...
public final class PutBucketRequestPaymentRequest extends S3Request implements
    ...
    private static final SdkField<RequestPaymentConfiguration> REQUEST_PAYMENT_CONFIGURATION_FIELD = SdkField
            ...
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("RequestPaymentConfiguration")
                    .unmarshallLocationName("RequestPaymentConfiguration").build(), PayloadTrait.create(), RequiredTrait.create())
            .build();
     ...
     * </p>
     * 
     * @return The Base64 encoded 128-bit <code>MD5</code> digest of the data. You must use this header as a message
     *         integrity check to verify that the request body was not corrupted in transit. For more information, see
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("RequestPaymentConfiguration", REQUEST_PAYMENT_CONFIGURATION_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutBucketRequestPaymentRequest> {
         ...
         * integrity check to verify that the request body was not corrupted in transit. For more information, see <a
         * href="http://www.ietf.org/rfc/rfc1864.txt">RFC 1864</a>.
         * </p>
         * <p>
         * For requests made using the Amazon Web Services Command Line Interface (CLI) or Amazon Web Services SDKs,
         ...
         *        see <a href="http://www.ietf.org/rfc/rfc1864.txt">RFC 1864</a>.</p>
         *        <p>
