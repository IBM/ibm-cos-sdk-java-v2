...
public final class ListBucketIntelligentTieringConfigurationsResponse extends S3Response
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("IntelligentTieringConfiguration", INTELLIGENT_TIERING_CONFIGURATION_LIST_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo,
         ...
         * {@link com.ibm.cos.v2.services.s3.model.IntelligentTieringConfiguration.Builder} avoiding the need to
         * create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.IntelligentTieringConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.IntelligentTieringConfiguration.Builder#build()} is called
         ...
         *        {@link com.ibm.cos.v2.services.s3.model.IntelligentTieringConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #intelligentTieringConfigurationList(java.util.Collection<IntelligentTieringConfiguration>)
         */
        Builder intelligentTieringConfigurationList(
