...
public final class ListBucketMetricsConfigurationsResponse extends S3Response implements
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("MetricsConfiguration", METRICS_CONFIGURATION_LIST_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo,
         ...
         * {@link com.ibm.cos.v2.services.s3.model.MetricsConfiguration.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.MetricsConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.MetricsConfiguration.Builder#build()} is called immediately
         * and its result is passed to {@link #metricsConfigurationList(List<MetricsConfiguration>)}.
         * 
         * @param metricsConfigurationList
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.MetricsConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #metricsConfigurationList(java.util.Collection<MetricsConfiguration>)
         */
