...
public class GetBucketProtectionConfigurationRequestMarshaller implements Marshaller<GetBucketProtectionConfigurationRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?protection")
                                                                            .httpMethod(SdkHttpMethod.GET).hasExplicitPayloadMember(true).hasPayloadMembers(true)
    ...
    public GetBucketProtectionConfigurationRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }


    @Override
    public SdkHttpFullRequest marshall(GetBucketProtectionConfigurationRequest getBucketProtectionConfigurationRequest) {

        Validate.paramNotNull(getBucketProtectionConfigurationRequest, "getBucketProtectionConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                .createProtocolMarshaller(SDK_OPERATION_BINDING);

            return protocolMarshaller.marshall(getBucketProtectionConfigurationRequest);
        } catch (Exception e) {
