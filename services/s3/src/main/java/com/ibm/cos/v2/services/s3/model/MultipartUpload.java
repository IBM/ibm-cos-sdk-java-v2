...
public final class MultipartUpload implements SdkPojo, Serializable, ToCopyableBuilder<MultipartUpload.Builder, MultipartUpload> {
    ...
    private static final SdkField<String> CHECKSUM_TYPE_FIELD = SdkField
            ...
            .getter(getter(MultipartUpload::checksumTypeAsString))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(UPLOAD_ID_FIELD, KEY_FIELD,
            INITIATED_FIELD, STORAGE_CLASS_FIELD, OWNER_FIELD, INITIATOR_FIELD, CHECKSUM_ALGORITHM_FIELD, CHECKSUM_TYPE_FIELD));
     ...
     * <note>
     * <p>
     * <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the objects.
     * </p>
     * </note>
     * 
     * @return Specifies the owner of the object that is part of the multipart upload. </p> <note>
     *         <p>
     *         <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the objects.
     *         </p>
     */
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, MultipartUpload> {
         ...
         * 
         * @param owner
         *        Specifies the owner of the object that is part of the multipart upload. </p> <note>
         *        <p>
         *        <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the objects.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
