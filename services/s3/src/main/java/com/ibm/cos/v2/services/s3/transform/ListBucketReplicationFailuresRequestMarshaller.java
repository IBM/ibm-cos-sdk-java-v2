...
public class ListBucketReplicationFailuresRequestMarshaller implements Marshaller<ListBucketReplicationFailuresRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?ibm-replication-failures")
    ...
    public ListBucketReplicationFailuresRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(ListBucketReplicationFailuresRequest listBucketReplicationFailuresRequest) {
        Validate.paramNotNull(listBucketReplicationFailuresRequest, "ListBucketReplicationFailuresRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listBucketReplicationFailuresRequest);
        } catch (Exception e) {
