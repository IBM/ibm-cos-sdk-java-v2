...
public final class AbortMultipartUploadRequest extends S3Request implements
    ...
    private static final SdkField<Instant> IF_MATCH_INITIATED_TIME_FIELD = SdkField
            .<Instant> builder(MarshallingType.INSTANT)
            .memberName("IfMatchInitiatedTime")
            .getter(getter(AbortMultipartUploadRequest::ifMatchInitiatedTime))
            .setter(setter(Builder::ifMatchInitiatedTime))
            .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-if-match-initiated-time")
                    .unmarshallLocationName("x-amz-if-match-initiated-time").build(),
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, KEY_FIELD,
            UPLOAD_ID_FIELD, REQUEST_PAYER_FIELD, EXPECTED_BUCKET_OWNER_FIELD, IF_MATCH_INITIATED_TIME_FIELD));
    ...
    private final Instant ifMatchInitiatedTime;
     ...
     * </note>
     * 
     * @return If present, this header aborts an in progress multipart upload only if it was initiated on the provided
     *         timestamp. If the initiated timestamp of the multipart upload does not match the provided value, the
     *         operation returns a <code>412 Precondition Failed</code> error. If the initiated timestamp matches or if
     *         the multipart upload doesn’t exist, the operation returns a <code>204 Success (No Content)</code>
     *         response. </p> <note>
     *         <p>
     *         This functionality is only supported for directory buckets.
     *         </p>
     */
    public final Instant ifMatchInitiatedTime() {
    ...
    public final int hashCode() {
        ...
        hashCode = 31 * hashCode + Objects.hashCode(ifMatchInitiatedTime());
        return hashCode;
    }
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(bucket(), other.bucket()) && Objects.equals(key(), other.key())
                ...
                && Objects.equals(ifMatchInitiatedTime(), other.ifMatchInitiatedTime());
    }
    ...
    public final String toString() {
        return ToString.builder("AbortMultipartUploadRequest").add("Bucket", bucket()).add("Key", key())
                ...
                .add("ExpectedBucketOwner", expectedBucketOwner()).add("IfMatchInitiatedTime", ifMatchInitiatedTime()).build();
    }
    ...
    public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
        ...
        case "IfMatchInitiatedTime":
            return Optional.ofNullable(clazz.cast(ifMatchInitiatedTime()));
        default:
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("x-amz-if-match-initiated-time", IF_MATCH_INITIATED_TIME_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, AbortMultipartUploadRequest> {
         ...
         * If present, this header aborts an in progress multipart upload only if it was initiated on the provided
         * timestamp. If the initiated timestamp of the multipart upload does not match the provided value, the
         * operation returns a <code>412 Precondition Failed</code> error. If the initiated timestamp matches or if the
         * multipart upload doesn’t exist, the operation returns a <code>204 Success (No Content)</code> response.
         * </p>
         * <note>
         * <p>
         * This functionality is only supported for directory buckets.
         ...
         * @return Returns a reference to this object so that method calls can be chained together.
         */
        Builder ifMatchInitiatedTime(Instant ifMatchInitiatedTime);
    ...
    static final class BuilderImpl extends S3Request.BuilderImpl implements Builder {
        ...
        private BuilderImpl(AbortMultipartUploadRequest model) {
            ...
            ifMatchInitiatedTime(model.ifMatchInitiatedTime);
        }
        ...
        public final Instant getIfMatchInitiatedTime() {
            return ifMatchInitiatedTime;
        }

        public final void setIfMatchInitiatedTime(Instant ifMatchInitiatedTime) {
            this.ifMatchInitiatedTime = ifMatchInitiatedTime;
        }

        @Override
        public final Builder ifMatchInitiatedTime(Instant ifMatchInitiatedTime) {
            this.ifMatchInitiatedTime = ifMatchInitiatedTime;
            return this;
        }
