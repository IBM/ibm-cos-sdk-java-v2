...
public final class ListPartsResponse extends S3Response implements
    ...
    private static final SdkField<String> CHECKSUM_TYPE_FIELD = SdkField
            ...
            .getter(getter(ListPartsResponse::checksumTypeAsString))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(ABORT_DATE_FIELD,
            ...
            STORAGE_CLASS_FIELD, REQUEST_CHARGED_FIELD, CHECKSUM_ALGORITHM_FIELD, CHECKSUM_TYPE_FIELD));
     ...
     *         for the <code>part-number-marker</code> request parameter in a subsequent request.
     */
     ...
     * <note>
     * <p>
     * <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the parts.
     * </p>
     * </note>
     * 
     * @return Container element that identifies the object owner, after the object is created. If multipart upload is
     *         initiated by an IAM user, this element provides the parent account ID and display name.</p> <note>
     *         <p>
     *         <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the parts.
     *         </p>
     */
     ...
     * </p>
     * 
     * @return The class of storage used to store the uploaded object.</p> <note>
     *         <p>
    ...
    public final String toString() {
        return ToString.builder("ListPartsResponse").add("AbortDate", abortDate()).add("AbortRuleId", abortRuleId())
                ...
                .add("RequestCharged", requestChargedAsString()).add("ChecksumAlgorithm", checksumAlgorithmAsString())
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, ListPartsResponse> {
         ...
         * the <code>part-number-marker</code> request parameter in a subsequent request.
         * </p>
         * 
         ...
         *        use for the <code>part-number-marker</code> request parameter in a subsequent request.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
         ...
         * {@link com.ibm.cos.v2.services.s3.model.Part.Builder} avoiding the need to create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.Part#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes, {@link com.ibm.cos.v2.services.s3.model.Part.Builder#build()} is
         * called immediately and its result is passed to {@link #parts(List<Part>)}.
         * 
         * @param parts
         *        a consumer that will call methods on {@link com.ibm.cos.v2.services.s3.model.Part.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #parts(java.util.Collection<Part>)
         */
         ...
         *        is initiated by an IAM user, this element provides the parent account ID and display name.</p> <note>
         *        <p>
         *        <b>Directory buckets</b> - The bucket owner is returned as the object owner for all the parts.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
         ...
         * 
         * @param storageClass
         *        The class of storage used to store the uploaded object.</p> <note>
         *        <p>
         *        <b>Directory buckets</b> - Directory buckets only support <code>EXPRESS_ONEZONE</code> (the S3 Express
         *        One Zone storage class) in Availability Zones and <code>ONEZONE_IA</code> (the S3 One Zone-Infrequent
         *        Access storage class) in Dedicated Local Zones.
