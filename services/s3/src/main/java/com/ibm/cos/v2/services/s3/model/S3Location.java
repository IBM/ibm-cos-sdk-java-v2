...
public final class S3Location implements SdkPojo, Serializable, ToCopyableBuilder<S3Location.Builder, S3Location> {
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("CannedACL", CANNED_ACL_FIELD);
        map.put("AccessControlList", ACCESS_CONTROL_LIST_FIELD);
        map.put("Tagging", TAGGING_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, S3Location> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.Grant.Builder} avoiding the need to create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.Grant#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes, {@link com.ibm.cos.v2.services.s3.model.Grant.Builder#build()}
         * is called immediately and its result is passed to {@link #accessControlList(List<Grant>)}.
         * 
         * @param accessControlList
         *        a consumer that will call methods on {@link com.ibm.cos.v2.services.s3.model.Grant.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #accessControlList(java.util.Collection<Grant>)
         */
         ...
         * </p>
         * This is a convenience method that creates an instance of the
         * {@link com.ibm.cos.v2.services.s3.model.MetadataEntry.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.MetadataEntry#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.MetadataEntry.Builder#build()} is called immediately and its
         * result is passed to {@link #userMetadata(List<MetadataEntry>)}.
         * 
         * @param userMetadata
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.MetadataEntry.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #userMetadata(java.util.Collection<MetadataEntry>)
         */
