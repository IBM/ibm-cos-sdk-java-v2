...
/**
 * {@link CreateSessionRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class CreateSessionRequestMarshaller implements Marshaller<CreateSessionRequest> {
    ...
    public SdkHttpFullRequest marshall(CreateSessionRequest createSessionRequest) {
        Validate.paramNotNull(createSessionRequest, "createSessionRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(createSessionRequest);
        } catch (Exception e) {
