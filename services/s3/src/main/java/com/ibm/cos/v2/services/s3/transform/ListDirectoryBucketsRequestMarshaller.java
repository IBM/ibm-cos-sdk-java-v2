...
/**
 * {@link ListDirectoryBucketsRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class ListDirectoryBucketsRequestMarshaller implements Marshaller<ListDirectoryBucketsRequest> {
    ...
    public ListDirectoryBucketsRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(ListDirectoryBucketsRequest listDirectoryBucketsRequest) {
        Validate.paramNotNull(listDirectoryBucketsRequest, "listDirectoryBucketsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listDirectoryBucketsRequest);
        } catch (Exception e) {
