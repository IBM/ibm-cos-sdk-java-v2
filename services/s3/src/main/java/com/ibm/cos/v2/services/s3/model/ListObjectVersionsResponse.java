...
public final class ListObjectVersionsResponse extends S3Response implements
    ...
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            ...
            .getter(getter(ListObjectVersionsResponse::requestChargedAsString))
     ...
     *         <code>NextKeyMarker</code> and <code>NextVersionIdMarker</code> response parameters as a starting place
     *         in another request to return the rest of the results.
     */
     ...
     *         the <code>version-id-marker</code> request parameter in a subsequent request.
     */
     ...
     * </p>
     * 
     * @return Container for an object that is a delete marker. To learn more about delete markers, see <a
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("KeyMarker", KEY_MARKER_FIELD);
        map.put("VersionIdMarker", VERSION_ID_MARKER_FIELD);
        map.put("NextKeyMarker", NEXT_KEY_MARKER_FIELD);
        map.put("NextVersionIdMarker", NEXT_VERSION_ID_MARKER_FIELD);
        map.put("Version", VERSIONS_FIELD);
        map.put("DeleteMarker", DELETE_MARKERS_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, ListObjectVersionsResponse> {
         ...
         * your results were truncated, you can make a follow-up paginated request by using the
         * <code>NextKeyMarker</code> and <code>NextVersionIdMarker</code> response parameters as a starting place in
         ...
         *        search criteria. Use this value for the <code>version-id-marker</code> request parameter in a
         *        subsequent request.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
         ...
         * {@link com.ibm.cos.v2.services.s3.model.ObjectVersion.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.ObjectVersion#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.ObjectVersion.Builder#build()} is called immediately and its
         * result is passed to {@link #versions(List<ObjectVersion>)}.
         * 
         * @param versions
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.ObjectVersion.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #versions(java.util.Collection<ObjectVersion>)
         */
         ...
         * </p>
         * This is a convenience method that creates an instance of the
         * {@link com.ibm.cos.v2.services.s3.model.DeleteMarkerEntry.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.DeleteMarkerEntry#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.DeleteMarkerEntry.Builder#build()} is called immediately and
         * its result is passed to {@link #deleteMarkers(List<DeleteMarkerEntry>)}.
         * 
         * @param deleteMarkers
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.DeleteMarkerEntry.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #deleteMarkers(java.util.Collection<DeleteMarkerEntry>)
         */
