...
public final class ListBucketInventoryConfigurationsResponse extends S3Response implements
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("InventoryConfiguration", INVENTORY_CONFIGURATION_LIST_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo,
         ...
         * {@link com.ibm.cos.v2.services.s3.model.InventoryConfiguration.Builder} avoiding the need to create
         * one manually via {@link com.ibm.cos.v2.services.s3.model.InventoryConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.InventoryConfiguration.Builder#build()} is called immediately
         * and its result is passed to {@link #inventoryConfigurationList(List<InventoryConfiguration>)}.
         * 
         * @param inventoryConfigurationList
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.InventoryConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #inventoryConfigurationList(java.util.Collection<InventoryConfiguration>)
         */
