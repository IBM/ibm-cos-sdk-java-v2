 ...
 * {@link com.ibm.cos.v2.services.s3.S3Client#listMultipartUploadsPaginator(com.ibm.cos.v2.services.s3.model.ListMultipartUploadsRequest)}
 * operation which is a paginated operation. This class is an iterable of
 * {@link com.ibm.cos.v2.services.s3.model.ListMultipartUploadsResponse} that can be used to iterate through all
 ...
 * <pre>
 * {@code
 * com.ibm.cos.v2.services.s3.paginators.ListMultipartUploadsIterable responses = client.listMultipartUploadsPaginator(request);
 ...
 * {
 *     &#064;code
 *     com.ibm.cos.v2.services.s3.paginators.ListMultipartUploadsIterable responses = client
 *             .listMultipartUploadsPaginator(request);
 *     for (com.ibm.cos.v2.services.s3.model.ListMultipartUploadsResponse response : responses) {
 *         // do something;
 *     }
 * }
 * </pre>
