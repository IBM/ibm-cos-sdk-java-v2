...
/**
 * {@link DeleteBucketMetadataTableConfigurationRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class DeleteBucketMetadataTableConfigurationRequestMarshaller implements
        Marshaller<DeleteBucketMetadataTableConfigurationRequest> {
    ...
    public DeleteBucketMetadataTableConfigurationRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(DeleteBucketMetadataTableConfigurationRequest deleteBucketMetadataTableConfigurationRequest) {
        Validate.paramNotNull(deleteBucketMetadataTableConfigurationRequest, "deleteBucketMetadataTableConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(deleteBucketMetadataTableConfigurationRequest);
        } catch (Exception e) {
