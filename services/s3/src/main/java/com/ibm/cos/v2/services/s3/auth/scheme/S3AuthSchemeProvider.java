...
import com.ibm.cos.v2.services.s3.auth.scheme.internal.DefaultS3AuthSchemeProvider;
...
public interface S3AuthSchemeProvider extends AuthSchemeProvider {
     ...
     */
    List<AuthSchemeOption> resolveAuthScheme(S3AuthSchemeParams authSchemeParams);
