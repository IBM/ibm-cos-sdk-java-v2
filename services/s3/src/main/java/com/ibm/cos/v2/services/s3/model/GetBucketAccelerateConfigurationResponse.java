...
public final class GetBucketAccelerateConfigurationResponse extends S3Response implements
    ...
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            ...
            .getter(getter(GetBucketAccelerateConfigurationResponse::requestChargedAsString))
    ...
    public final String toString() {
        return ToString.builder("GetBucketAccelerateConfigurationResponse").add("Status", statusAsString())
