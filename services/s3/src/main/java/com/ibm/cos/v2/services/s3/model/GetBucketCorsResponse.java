...
public final class GetBucketCorsResponse extends S3Response implements
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("CORSRule", CORS_RULES_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketCorsResponse> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.CORSRule.Builder} avoiding the need to create one manually
         * via {@link com.ibm.cos.v2.services.s3.model.CORSRule#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.CORSRule.Builder#build()} is called immediately and its
         * result is passed to {@link #corsRules(List<CORSRule>)}.
         * 
         * @param corsRules
         *        a consumer that will call methods on {@link com.ibm.cos.v2.services.s3.model.CORSRule.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #corsRules(java.util.Collection<CORSRule>)
         */
