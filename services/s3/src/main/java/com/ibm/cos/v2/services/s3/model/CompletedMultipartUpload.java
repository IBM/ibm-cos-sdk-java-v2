...
public final class CompletedMultipartUpload implements SdkPojo, Serializable,
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, CompletedMultipartUpload> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.CompletedPart.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.CompletedPart#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.CompletedPart.Builder#build()} is called immediately and its
         * result is passed to {@link #parts(List<CompletedPart>)}.
         * 
         * @param parts
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.CompletedPart.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #parts(java.util.Collection<CompletedPart>)
         */
