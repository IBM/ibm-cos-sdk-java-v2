...
public abstract class DelegatingS3Client implements S3Client {
    ...
    public <ReturnT> ReturnT getObject(GetObjectRequest getObjectRequest,
        ...
        return invokeOperation(getObjectRequest, request -> delegate.getObject(request, responseTransformer));
    }
    ...
    public <ReturnT> ReturnT getObjectTorrent(GetObjectTorrentRequest getObjectTorrentRequest,
            ...
            SdkClientException, S3Exception {
        return invokeOperation(getObjectTorrentRequest, request -> delegate.getObjectTorrent(request, responseTransformer));
    }
