...
public final class NoncurrentVersionTransition implements SdkPojo, Serializable,
     ...
     * noncurrent versions beyond the specified number to retain. For more information about noncurrent versions, see <a
     ...
     * </p>
     * 
     * @return Specifies how many noncurrent versions Amazon S3 will retain in the same storage class before
     *         transitioning objects. You can specify up to 100 noncurrent versions to retain. Amazon S3 will transition
     *         any additional noncurrent versions beyond the specified number to retain. For more information about
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, NoncurrentVersionTransition> {
         ...
         * Specifies how many noncurrent versions Amazon S3 will retain in the same storage class before transitioning
         * objects. You can specify up to 100 noncurrent versions to retain. Amazon S3 will transition any additional
         * noncurrent versions beyond the specified number to retain. For more information about noncurrent versions,
