...
public final class Transition implements SdkPojo, Serializable, ToCopyableBuilder<Transition.Builder, Transition> {
     ...
     * specified storage class is <code>INTELLIGENT_TIERING</code>, <code>GLACIER_IR</code>, <code>GLACIER</code>, or
     * <code>DEEP_ARCHIVE</code>, valid values are <code>0</code> or positive integers. If the specified storage class
     * is <code>STANDARD_IA</code> or <code>ONEZONE_IA</code>, valid values are positive integers greater than
     * <code>30</code>. Be aware that some storage classes have a minimum storage duration and that you're charged for
     * transitioning objects before their minimum storage duration. For more information, see <a href=
     ...
     *         If the specified storage class is <code>INTELLIGENT_TIERING</code>, <code>GLACIER_IR</code>,
     *         <code>GLACIER</code>, or <code>DEEP_ARCHIVE</code>, valid values are <code>0</code> or positive integers.
     *         If the specified storage class is <code>STANDARD_IA</code> or <code>ONEZONE_IA</code>, valid values are
     *         positive integers greater than <code>30</code>. Be aware that some storage classes have a minimum storage
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, Transition> {
        ...
        /**
         * <p>
         * Indicates the number of days after creation when objects are transitioned to the specified storage class. If
         * the specified storage class is <code>INTELLIGENT_TIERING</code>, <code>GLACIER_IR</code>,
         * <code>GLACIER</code>, or <code>DEEP_ARCHIVE</code>, valid values are <code>0</code> or positive integers. If
         * the specified storage class is <code>STANDARD_IA</code> or <code>ONEZONE_IA</code>, valid values are positive
         * integers greater than <code>30</code>. Be aware that some storage classes have a minimum storage duration and
         * that you're charged for transitioning objects before their minimum storage duration. For more information,
         * see <a href=
         * "https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-transition-general-considerations.html#lifecycle-configuration-constraints"
         * > Constraints and considerations for transitions</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         ...
         *        minimum storage duration and that you're charged for transitioning objects before their minimum
         *        storage duration. For more information, see <a href=
         *        "https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-transition-general-considerations.html#lifecycle-configuration-constraints"
         *        > Constraints and considerations for transitions</a> in the <i>Amazon S3 User Guide</i>.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
