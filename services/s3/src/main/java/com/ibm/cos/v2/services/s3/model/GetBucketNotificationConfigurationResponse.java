...
public final class GetBucketNotificationConfigurationResponse extends S3Response implements
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("TopicConfiguration", TOPIC_CONFIGURATIONS_FIELD);
        map.put("QueueConfiguration", QUEUE_CONFIGURATIONS_FIELD);
        map.put("CloudFunctionConfiguration", LAMBDA_FUNCTION_CONFIGURATIONS_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo,
         ...
         * {@link com.ibm.cos.v2.services.s3.model.TopicConfiguration.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.TopicConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.TopicConfiguration.Builder#build()} is called immediately and
         * its result is passed to {@link #topicConfigurations(List<TopicConfiguration>)}.
         * 
         * @param topicConfigurations
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.TopicConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         ...
         * </p>
         * This is a convenience method that creates an instance of the
         * {@link com.ibm.cos.v2.services.s3.model.QueueConfiguration.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.QueueConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.QueueConfiguration.Builder#build()} is called immediately and
         * its result is passed to {@link #queueConfigurations(List<QueueConfiguration>)}.
         * 
         * @param queueConfigurations
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.QueueConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #queueConfigurations(java.util.Collection<QueueConfiguration>)
         */
         ...
         * </p>
         * This is a convenience method that creates an instance of the
         * {@link com.ibm.cos.v2.services.s3.model.LambdaFunctionConfiguration.Builder} avoiding the need to
         * create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.LambdaFunctionConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.LambdaFunctionConfiguration.Builder#build()} is called
         ...
         *        {@link com.ibm.cos.v2.services.s3.model.LambdaFunctionConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #lambdaFunctionConfigurations(java.util.Collection<LambdaFunctionConfiguration>)
         */
