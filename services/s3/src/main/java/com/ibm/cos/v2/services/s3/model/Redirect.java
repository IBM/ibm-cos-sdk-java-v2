...
public final class Redirect implements SdkPojo, Serializable, ToCopyableBuilder<Redirect.Builder, Redirect> {
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("HttpRedirectCode", HTTP_REDIRECT_CODE_FIELD);
        map.put("Protocol", PROTOCOL_FIELD);
        map.put("ReplaceKeyPrefixWith", REPLACE_KEY_PREFIX_WITH_FIELD);
        map.put("ReplaceKeyWith", REPLACE_KEY_WITH_FIELD);
