...
import com.ibm.cos.v2.services.s3.endpoints.internal.Value;
...
public final class HeadObjectResponse extends S3Response implements
    ...
    private static final SdkField<String> CHECKSUM_CRC64_NVME_FIELD = SdkField
            ...
            .getter(getter(HeadObjectResponse::checksumCRC64NVME))
    ...
    private static final SdkField<String> CHECKSUM_TYPE_FIELD = SdkField
            ...
            .getter(getter(HeadObjectResponse::checksumTypeAsString))
    ...
    private static final SdkField<String> CONTENT_RANGE_FIELD = SdkField
            ...
            .getter(getter(HeadObjectResponse::contentRange))
    ...
    private static final SdkField<String> EXPIRES_STRING_FIELD = SdkField
            ...
            .getter(getter(HeadObjectResponse::expiresString))
            .setter(setter(Builder::expiresString))
            .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("Expires")
                    .unmarshallLocationName("Expires").build()).build();

    /********************************************** IBM Supported ***************************************************************/
    /** IBM Transition header */
    private static final SdkField<String> IBM_TRANSITION_FIELD = SdkField
        .<String> builder(MarshallingType.STRING)
        .memberName("IBMTranstionId")
        .getter(getter(HeadObjectResponse::ibmTransition))
        .setter(setter(Builder::ibmTransition))
        .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-ibm-transition")
                             .unmarshallLocationName("x-ibm-transition").build()).build();

    /** IBM Restored Copy StorageClass header */
    private static final SdkField<String> IBM_RESTORED_COPY_STORAGE_CLASS_FIELD = SdkField
        .<String> builder(MarshallingType.STRING)
        .memberName("IBMRestoredCopyStorageClass")
        .getter(getter(HeadObjectResponse::ibmRestoredCopyStorageClass))
        .setter(setter(Builder::ibmRestoredCopyStorageClass))
        .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-ibm-restored-copy-storage-class")
                             .unmarshallLocationName("x-ibm-restored-copy-storage-class").build()).build();
    ...
    private static final SdkField<Instant> IBM_RETENTION_EXPIRATION_DATE_FIELD = SdkField
        ...
        .getter(getter(HeadObjectResponse::retentionExpirationDate))
    ...
    private static final SdkField<Integer> IBM_RETENTION_LEGAL_HOLD_COUNT_FIELD = SdkField
        ...
        .getter(getter(HeadObjectResponse::retentionLegalHoldCount))
        .setter(setter(Builder::retentionLegalHoldCount))
    ...
    private static final SdkField<Long> IBM_RETENTION_PERIOD_FIELD = SdkField
        ...
        .getter(getter(HeadObjectResponse::retentionPeriod))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(DELETE_MARKER_FIELD,
            ...
            CONTENT_LENGTH_FIELD, CHECKSUM_CRC32_FIELD, CHECKSUM_CRC32_C_FIELD, CHECKSUM_CRC64_NVME_FIELD, CHECKSUM_SHA1_FIELD,
            CHECKSUM_SHA256_FIELD, CHECKSUM_TYPE_FIELD, E_TAG_FIELD, MISSING_META_FIELD, VERSION_ID_FIELD, CACHE_CONTROL_FIELD,
            CONTENT_DISPOSITION_FIELD, CONTENT_ENCODING_FIELD, CONTENT_LANGUAGE_FIELD, CONTENT_TYPE_FIELD, CONTENT_RANGE_FIELD,
            ...
            STORAGE_CLASS_FIELD, REQUEST_CHARGED_FIELD, REPLICATION_STATUS_FIELD, PARTS_COUNT_FIELD, OBJECT_LOCK_MODE_FIELD,
            OBJECT_LOCK_RETAIN_UNTIL_DATE_FIELD, OBJECT_LOCK_LEGAL_HOLD_STATUS_FIELD, EXPIRES_STRING_FIELD,
            IBM_TRANSITION_FIELD, IBM_RESTORED_COPY_STORAGE_CLASS_FIELD, IBM_RETENTION_EXPIRATION_DATE_FIELD,
    ...
    /************* IBM fields ***********/
    private final String ibmTransitionId;

    private final String ibmRestoredCopyStorageClass;
    ...
    private HeadObjectResponse(BuilderImpl builder) {
        ...
        this.ibmTransitionId = builder.ibmTransitionId;
        this.ibmRestoredCopyStorageClass = builder.ibmRestoredCopyStorageClass;
     ...
     * </p>
     * 
     * @return The archive state of the head object.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     * @see ArchiveStatus
     ...
     *         received is the same checksum type that was specified in <code>CreateMultipartUpload</code> request. For
     ...
     *         API. For example, using SOAP, you can create metadata whose values are not legal HTTP headers.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     */
     ...
     * </p>
     * 
     * @return The portion of the object returned in the response for a <code>GET</code> request.
     */
     ...
     *         requester has the <code>s3:GetObjectRetention</code> permission.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     */
    ...
    /**
     * IBM-specific
     * @return The IBM Transition ID (x-ibm-transition) header
     */
    public final String ibmTransition() { return ibmTransitionId; }

    /**
     * IBM-specific
     * @return The IBM Restored Copy storage class header
     */
    public final String ibmRestoredCopyStorageClass() { return ibmRestoredCopyStorageClass; }
    ...
    public final int hashCode() {
        ...
        hashCode = 31 * hashCode + Objects.hashCode(ibmTransition());
        hashCode = 31 * hashCode + Objects.hashCode(ibmRestoredCopyStorageClass());
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(deleteMarker(), other.deleteMarker()) && Objects.equals(acceptRanges(), other.acceptRanges())
                ...
                && Objects.equals(checksumTypeAsString(), other.checksumTypeAsString()) && Objects.equals(eTag(), other.eTag())
                ...
                && Objects.equals(contentType(), other.contentType()) && Objects.equals(contentRange(), other.contentRange())
                ...
                && Objects.equals(ibmTransition(), other.ibmTransition())
                && Objects.equals(ibmRestoredCopyStorageClass(), other.ibmRestoredCopyStorageClass())
    ...
    public final String toString() {
        return ToString.builder("HeadObjectResponse").add("DeleteMarker", deleteMarker()).add("AcceptRanges", acceptRanges())
                ...
                .add("ChecksumType", checksumTypeAsString()).add("ETag", eTag()).add("MissingMeta", missingMeta())
                ...
                .add("ContentLanguage", contentLanguage()).add("ContentType", contentType()).add("ContentRange", contentRange())
                ...
                .add("IBMTranstionId", ibmTransition())
                .add("IBMRestoredCopyStorageClass", ibmRestoredCopyStorageClass())
                .add("RetentionExpirationDate", retentionExpirationDate())
                .add("RetentionPeriod", retentionPeriod())
                .add("RetentionLegalHoldCount", retentionLegalHoldCount())
                .build();
    }
    ...
    public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
        ...
        case "IBMTransitionId":
                return Optional.ofNullable(clazz.cast(ibmTransition()));
        case "IBMRestoredCopyStorageClass":
                return Optional.ofNullable(clazz.cast(ibmRestoredCopyStorageClass()));
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("x-amz-archive-status", ARCHIVE_STATUS_FIELD);
        ...
        map.put("x-ibm-transition", IBM_TRANSITION_FIELD);
        map.put("x-ibm-restored-copy-storage-class", IBM_RESTORED_COPY_STORAGE_CLASS_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, HeadObjectResponse> {
         ...
         * 
         * @param archiveStatus
         *        The archive state of the head object.</p> <note>
         *        <p>
         *        This functionality is not supported for directory buckets.
         *        </p>
         * @see ArchiveStatus
         ...
         * the same checksum type that was specified in <code>CreateMultipartUpload</code> request. For more
         * information, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object
         * integrity in the Amazon S3 User Guide</a>.
         * </p>
         ...
         *        is received is the same checksum type that was specified in <code>CreateMultipartUpload</code>
        ...
        Builder ibmTransition(String ibmTransitionId);


        Builder ibmRestoredCopyStorageClass(String ibmRestoredCopyStorageClass);
    ...
    static final class BuilderImpl extends S3Response.BuilderImpl implements Builder {
        ...
        /********** IBM fields ***************/
        private String ibmTransitionId;

        private String ibmRestoredCopyStorageClass;
        ...
        private BuilderImpl(HeadObjectResponse model) {
            ...
            ibmTransition(model.ibmTransitionId);
            ibmRestoredCopyStorageClass(model.ibmRestoredCopyStorageClass);
        ...
        public final String getIbmTransition() {
            return ibmTransitionId;
        }

        public final void setIbmTransition(String ibmTransitionId) {
            this.ibmTransitionId = ibmTransitionId;
        }

        @Override
        public final Builder ibmTransition(String ibmTransitionId) {
            this.ibmTransitionId = ibmTransitionId;
            return this;
        }

        public final String getIbmRestoredCopyStorageClass() {
            return ibmRestoredCopyStorageClass;
        }

        public final void setIbmRestoredCopyStorageClass(String ibmRestoredCopyStorageClass) {
            this.ibmRestoredCopyStorageClass = ibmRestoredCopyStorageClass;
        }

        @Override
        public final Builder ibmRestoredCopyStorageClass(String ibmRestoredCopyStorageClass) {
            this.ibmRestoredCopyStorageClass = ibmRestoredCopyStorageClass;
            return this;
        }
