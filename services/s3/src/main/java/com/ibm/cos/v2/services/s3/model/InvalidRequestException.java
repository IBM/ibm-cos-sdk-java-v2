...
public final class InvalidRequestException extends S3Exception implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, InvalidRequestException>, S3Exception.Builder {
        @Override
