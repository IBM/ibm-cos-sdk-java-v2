...
/**
 * {@link CreateBucketMetadataTableConfigurationRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class CreateBucketMetadataTableConfigurationRequestMarshaller implements
        Marshaller<CreateBucketMetadataTableConfigurationRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("?metadataTable")
    ...
    public CreateBucketMetadataTableConfigurationRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(CreateBucketMetadataTableConfigurationRequest createBucketMetadataTableConfigurationRequest) {
        Validate.paramNotNull(createBucketMetadataTableConfigurationRequest, "createBucketMetadataTableConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(createBucketMetadataTableConfigurationRequest);
        } catch (Exception e) {
