...
public final class UploadPartRequest extends S3Request implements ToCopyableBuilder<UploadPartRequest.Builder, UploadPartRequest> {
    ...
    private static final SdkField<String> CHECKSUM_CRC64_NVME_FIELD = SdkField
            ...
            .getter(getter(UploadPartRequest::checksumCRC64NVME))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD,
            ...
            CHECKSUM_CRC64_NVME_FIELD, CHECKSUM_SHA1_FIELD, CHECKSUM_SHA256_FIELD, KEY_FIELD, PART_NUMBER_FIELD, UPLOAD_ID_FIELD,
     ...
     *         command from the CLI. This parameter is required if object lock parameters are specified.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     */
     ...
     *         be a corresponding <code>x-amz-checksum</code> or <code>x-amz-trailer</code> header sent. Otherwise,
    ...
    public final String toString() {
        return ToString.builder("UploadPartRequest").add("Bucket", bucket()).add("ContentLength", contentLength())
                ...
                .add("ChecksumSHA256", checksumSHA256()).add("Key", key()).add("PartNumber", partNumber())
                .add("UploadId", uploadId()).add("SSECustomerAlgorithm", sseCustomerAlgorithm())
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, UploadPartRequest> {
         ...
         * @see SdkPartType
         */
        Builder sdkPartType(String sdkPartType);
         ...
         * @see SdkPartType
         */
        Builder sdkPartType(SdkPartType sdkPartType);
