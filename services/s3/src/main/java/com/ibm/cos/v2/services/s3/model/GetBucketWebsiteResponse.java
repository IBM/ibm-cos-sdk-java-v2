...
public final class GetBucketWebsiteResponse extends S3Response implements
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("IndexDocument", INDEX_DOCUMENT_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketWebsiteResponse> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.RoutingRule.Builder} avoiding the need to create one manually
         * via {@link com.ibm.cos.v2.services.s3.model.RoutingRule#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.RoutingRule.Builder#build()} is called immediately and its
         * result is passed to {@link #routingRules(List<RoutingRule>)}.
         * 
         * @param routingRules
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.RoutingRule.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #routingRules(java.util.Collection<RoutingRule>)
         */
