...
public final class ReplicationRule implements SdkPojo, Serializable, ToCopyableBuilder<ReplicationRule.Builder, ReplicationRule> {
     ...
     * <note>
     * <p>
     * This parameter is no longer supported. To replicate existing objects, see <a
     * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-batch-replication-batch.html">Replicating existing
     * objects with S3 Batch Replication</a> in the <i>Amazon S3 User Guide</i>.
     * </p>
     * </note>
     * 
     * @return Optional configuration to replicate existing source bucket objects. </p> <note>
     *         <p>
     *         This parameter is no longer supported. To replicate existing objects, see <a
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("SourceSelectionCriteria", SOURCE_SELECTION_CRITERIA_FIELD);
        map.put("ExistingObjectReplication", EXISTING_OBJECT_REPLICATION_FIELD);
        map.put("Destination", DESTINATION_FIELD);
        map.put("DeleteMarkerReplication", DELETE_MARKER_REPLICATION_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ReplicationRule> {
         ...
         *        Optional configuration to replicate existing source bucket objects. </p> <note>
         *        <p>
         *        This parameter is no longer supported. To replicate existing objects, see <a
         *        href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-batch-replication-batch.html"
         *        >Replicating existing objects with S3 Batch Replication</a> in the <i>Amazon S3 User Guide</i>.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
         */
         ...
         * {@link ExistingObjectReplication.Builder} avoiding the need to create one manually via
         * {@link ExistingObjectReplication#builder()}.
         *
         * <p>
