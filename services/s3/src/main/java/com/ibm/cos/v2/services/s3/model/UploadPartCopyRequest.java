...
public final class UploadPartCopyRequest extends S3Request implements
     ...
     * <code>x-amz-copy-source</code> identifies the current version of the source object to copy. To copy a specific
     * version of the source object to copy, append <code>?versionId=&lt;version-id&gt;</code> to the
     ...
     * </p>
     * <p>
     * If the current version is a delete marker and you don't specify a versionId in the <code>x-amz-copy-source</code>
     ...
     *         <p>
     *         If your bucket has versioning enabled, you could have multiple versions of the same object. By default,
     *         <code>x-amz-copy-source</code> identifies the current version of the source object to copy. To copy a
     *         specific version of the source object to copy, append <code>?versionId=&lt;version-id&gt;</code> to the
     *         <code>x-amz-copy-source</code> request header (for example,
     *         <code>x-amz-copy-source: /awsexamplebucket/reports/january.pdf?versionId=QUpfdndhfd8438MNFDN93jdnJFkdmqnh893</code>
     *         ).
     *         </p>
     ...
     *         because the object does not exist. If you specify versionId in the <code>x-amz-copy-source</code> and the
     *         versionId is a delete marker, Amazon S3 returns an HTTP <code>400 Bad Request</code> error, because you
     *         are not allowed to specify a delete marker as a version for the <code>x-amz-copy-source</code>.
     *         </p>
     *         <note>
     *         <p>
     *         <b>Directory buckets</b> - S3 Versioning isn't enabled and supported for directory buckets.
     ...
     * </p>
     * <p>
     * If both of the <code>x-amz-copy-source-if-match</code> and <code>x-amz-copy-source-if-unmodified-since</code>
     ...
     *         <code>x-amz-server-side-encryption-customer-algorithm</code> header. This must be the same encryption key
     *         specified in the initiate multipart upload request.</p> <note>
     *         <p>
     *         This functionality is not supported when the destination bucket is a directory bucket.
     *         </p>
     */
     ...
     *         encryption key provided in this header must be one that was used when the source object was created.</p>
     *         <note>
     *         <p>
     *         This functionality is not supported when the source object is in a directory bucket.
     *         </p>
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, UploadPartCopyRequest> {
         ...
         * <p>
         * If the current version is a delete marker and you don't specify a versionId in the
         * <code>x-amz-copy-source</code> request header, Amazon S3 returns a <code>404 Not Found</code> error, because
         * the object does not exist. If you specify versionId in the <code>x-amz-copy-source</code> and the versionId
         * is a delete marker, Amazon S3 returns an HTTP <code>400 Bad Request</code> error, because you are not allowed
         * to specify a delete marker as a version for the <code>x-amz-copy-source</code>.
         * </p>
         * <note>
         * <p>
         * <b>Directory buckets</b> - S3 Versioning isn't enabled and supported for directory buckets.
         ...
         *        default, <code>x-amz-copy-source</code> identifies the current version of the source object to copy.
         *        To copy a specific version of the source object to copy, append
         *        <code>?versionId=&lt;version-id&gt;</code> to the <code>x-amz-copy-source</code> request header (for
         *        example,
         *        <code>x-amz-copy-source: /awsexamplebucket/reports/january.pdf?versionId=QUpfdndhfd8438MNFDN93jdnJFkdmqnh893</code>
         *        ).
         *        </p>
         ...
         *        the versionId is a delete marker, Amazon S3 returns an HTTP <code>400 Bad Request</code> error,
         ...
         *        key specified in the initiate multipart upload request.</p> <note>
         *        <p>
         *        This functionality is not supported when the destination bucket is a directory bucket.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
