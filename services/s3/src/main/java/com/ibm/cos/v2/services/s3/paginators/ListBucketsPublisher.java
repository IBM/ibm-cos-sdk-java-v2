 ...
 * {@link com.ibm.cos.v2.services.s3.S3AsyncClient#listBucketsPaginator(com.ibm.cos.v2.services.s3.model.ListBucketsRequest)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link com.ibm.cos.v2.services.s3.model.ListBucketsResponse} response pages as
 ...
 * <pre>
 * {@code
 * com.ibm.cos.v2.services.s3.paginators.ListBucketsPublisher publisher = client.listBucketsPaginator(request);
 ...
 * {@code
 * com.ibm.cos.v2.services.s3.paginators.ListBucketsPublisher publisher = client.listBucketsPaginator(request);
 * publisher.subscribe(new Subscriber<com.ibm.cos.v2.services.s3.model.ListBucketsResponse>() {
 * 
 * public void onSubscribe(org.reactivestreams.Subscriber subscription) { //... };
 * 
 * 
 * public void onNext(com.ibm.cos.v2.services.s3.model.ListBucketsResponse response) { //... };
 * });}
 * </pre>
 * 
...
public class ListBucketsPublisher implements SdkPublisher<ListBucketsResponse> {
    ...
    public final SdkPublisher<Bucket> buckets() {
        ...
        return PaginatedItemsPublisher.builder().nextPageFetcher(new ListBucketsResponseFetcher()).iteratorFunction(getIterator)
                .isLastPage(isLastPage).build();
    }

    private class ListBucketsResponseFetcher implements AsyncPageFetcher<ListBucketsResponse> {
        @Override
        public boolean hasNextPage(final ListBucketsResponse previousPage) {
            return PaginatorUtils.isOutputTokenAvailable(previousPage.continuationToken());
        }

        @Override
        public CompletableFuture<ListBucketsResponse> nextPage(final ListBucketsResponse previousPage) {
