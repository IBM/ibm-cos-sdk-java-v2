...
public final class ListBucketAnalyticsConfigurationsResponse extends S3Response implements
    ...
    public interface Builder extends S3Response.Builder, SdkPojo,
         ...
         * {@link com.ibm.cos.v2.services.s3.model.AnalyticsConfiguration.Builder} avoiding the need to create
         * one manually via {@link com.ibm.cos.v2.services.s3.model.AnalyticsConfiguration#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.AnalyticsConfiguration.Builder#build()} is called immediately
         * and its result is passed to {@link #analyticsConfigurationList(List<AnalyticsConfiguration>)}.
         * 
         * @param analyticsConfigurationList
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.AnalyticsConfiguration.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #analyticsConfigurationList(java.util.Collection<AnalyticsConfiguration>)
         */
