...
public class DeleteLegalHoldRequestMarshaller implements Marshaller<DeleteLegalHoldRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder()
                                                                            ...
                                                                            .putAdditionalMetadata(AwsXmlProtocolFactory.ROOT_MARSHALL_LOCATION_ATTRIBUTE, "DeleteLegalHolds")
                                                                            .putAdditionalMetadata(AwsXmlProtocolFactory.XML_NAMESPACE_ATTRIBUTE, "http://s3.amazonaws.com/doc/2006-03-01/")
                                                                            .build();

    private final AwsXmlProtocolFactory protocolFactory;

    public DeleteLegalHoldRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(DeleteLegalHoldRequest listLegalHoldsRequest) {

        Validate.paramNotNull(listLegalHoldsRequest, "DeleteLegalHoldRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                .createProtocolMarshaller(SDK_OPERATION_BINDING);

            SdkHttpFullRequest request = protocolMarshaller.marshall(listLegalHoldsRequest);
