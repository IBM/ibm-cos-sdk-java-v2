 ...
 * </p>
 * <p>
 * Learn <a href="http://aws.amazon.com/blogs/storage/how-to-optimize-querying-your-data-in-amazon-s3/">How to optimize
 * querying your data in Amazon S3</a> using <a href="https://docs.aws.amazon.com/athena/latest/ug/what-is.html">Amazon
 * Athena</a>, <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/transforming-objects.html">S3 Object
 * Lambda</a>, or client-side filtering.
 * </p>
 */
...
public final class SelectParameters implements SdkPojo, Serializable,
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, SelectParameters> {
         ...
         * <important>
         * <p>
         * Amazon S3 Select is no longer available to new customers. Existing customers of Amazon S3 Select can continue
         * to use the feature as usual. <a
         * href="http://aws.amazon.com/blogs/storage/how-to-optimize-querying-your-data-in-amazon-s3/">Learn more</a>
         * </p>
         * </important>
         * <p>
