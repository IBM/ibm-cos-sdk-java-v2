...
public final class PutBucketEncryptionRequest extends S3Request implements
     ...
     * </p>
     * 
     * @return Specifies default encryption for a bucket using server-side encryption with different key options.</p>
     *         <p>
     ...
     * </note>
     * 
     * @return The Base64 encoded 128-bit <code>MD5</code> digest of the server-side encryption configuration.</p>
     *         <p>
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutBucketEncryptionRequest> {
         ...
         * 
         * @param bucket
         *        Specifies default encryption for a bucket using server-side encryption with different key options.</p>
         *        <p>
         ...
         * 
         * @param contentMD5
         *        The Base64 encoded 128-bit <code>MD5</code> digest of the server-side encryption configuration.</p>
         *        <p>
