 ...
 * <note>
 * <p>
 * <b>Directory buckets</b> - These session credentials are only supported for the authentication and authorization of
 * Zonal endpoint API operations on directory buckets.
 * </p>
 * </note>
 */
@Generated("com.ibm.cos.v2:codegen")
public final class SessionCredentials implements SdkPojo, Serializable,
        ToCopyableBuilder<SessionCredentials.Builder, SessionCredentials> {
    private static final SdkField<String> ACCESS_KEY_ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("AccessKeyId")
            .getter(getter(SessionCredentials::accessKeyId))
            .setter(setter(Builder::accessKeyId))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("AccessKeyId")
                    .unmarshallLocationName("AccessKeyId").build(), RequiredTrait.create()).build();

    private static final SdkField<String> SECRET_ACCESS_KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("SecretAccessKey")
            .getter(getter(SessionCredentials::secretAccessKey))
            .setter(setter(Builder::secretAccessKey))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SecretAccessKey")
                    .unmarshallLocationName("SecretAccessKey").build(), RequiredTrait.create()).build();

    private static final SdkField<String> SESSION_TOKEN_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("SessionToken")
            .getter(getter(SessionCredentials::sessionToken))
            .setter(setter(Builder::sessionToken))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("SessionToken")
                    .unmarshallLocationName("SessionToken").build(), RequiredTrait.create()).build();

    private static final SdkField<Instant> EXPIRATION_FIELD = SdkField
            .<Instant> builder(MarshallingType.INSTANT)
            .memberName("Expiration")
            .getter(getter(SessionCredentials::expiration))
    ...
    private SessionCredentials(BuilderImpl builder) {
     ...
     * </p>
     * 
     * @return A unique identifier that's associated with a secret access key. The access key ID and the secret access
     *         key are used together to sign programmatic Amazon Web Services requests cryptographically.
     */
     ...
     * </p>
     * 
     * @return A key that's used with the access key ID to cryptographically sign programmatic Amazon Web Services
     ...
     * </p>
     * 
     * @return A part of the temporary security credentials. The session token is used to validate the temporary
     ...
     * </p>
     * 
     * @return Temporary security credentials expire after a specified interval. After temporary credentials expire, any
     *         calls that you make with those credentials will fail. So you must generate a new set of temporary
     *         credentials. Temporary credentials cannot be extended or refreshed beyond the original specified
     *         interval.
     */
    ...
    public final String toString() {
        return ToString.builder("SessionCredentials").add("AccessKeyId", accessKeyId())
    ...
    private static <T> Function<Object, T> getter(Function<SessionCredentials, T> g) {
        return obj -> g.apply((SessionCredentials) obj);
    }
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, SessionCredentials> {
        /**
         * <p>
         * A unique identifier that's associated with a secret access key. The access key ID and the secret access key
         * are used together to sign programmatic Amazon Web Services requests cryptographically.
         * </p>
         * 
         * @param accessKeyId
        ...
        /**
         * <p>
         * Temporary security credentials expire after a specified interval. After temporary credentials expire, any
         * calls that you make with those credentials will fail. So you must generate a new set of temporary
         * credentials. Temporary credentials cannot be extended or refreshed beyond the original specified interval.
         * </p>
         * 
         * @param expiration
         *        Temporary security credentials expire after a specified interval. After temporary credentials expire,
         *        any calls that you make with those credentials will fail. So you must generate a new set of temporary
         *        credentials. Temporary credentials cannot be extended or refreshed beyond the original specified
         *        interval.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
    ...
    static final class BuilderImpl implements Builder {
        ...
        private BuilderImpl(SessionCredentials model) {
