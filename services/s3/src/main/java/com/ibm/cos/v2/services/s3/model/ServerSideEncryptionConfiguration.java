...
public final class ServerSideEncryptionConfiguration implements SdkPojo, Serializable,
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ServerSideEncryptionConfiguration> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.ServerSideEncryptionRule.Builder} avoiding the need to create
         * one manually via {@link com.ibm.cos.v2.services.s3.model.ServerSideEncryptionRule#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.ServerSideEncryptionRule.Builder#build()} is called
         * immediately and its result is passed to {@link #rules(List<ServerSideEncryptionRule>)}.
         * 
         * @param rules
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.ServerSideEncryptionRule.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #rules(java.util.Collection<ServerSideEncryptionRule>)
         */
