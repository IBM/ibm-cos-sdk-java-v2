 ...
 * lifecycle</a> in the <i>Amazon S3 User Guide</i>.
 * </p>
 */
...
public final class LifecycleRule implements SdkPojo, Serializable, ToCopyableBuilder<LifecycleRule.Builder, LifecycleRule> {
     ...
     * <note>
     * <p>
     * <code>Tag</code> filters are not supported for directory buckets.
     * </p>
     * </note>
     * 
     ...
     *         <code>Prefix</code> element.</p> <note>
     *         <p>
     *         <code>Tag</code> filters are not supported for directory buckets.
     *         </p>
     */
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, LifecycleRule> {
         ...
         *        contain a <code>Prefix</code> element.</p> <note>
         *        <p>
         *        <code>Tag</code> filters are not supported for directory buckets.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
         ...
         * <code>Tag</code> filters are not supported for directory buckets.
         * </p>
         * </note> This is a convenience method that creates an instance of the {@link LifecycleRuleFilter.Builder}
         * avoiding the need to create one manually via {@link LifecycleRuleFilter#builder()}.
         *
         * <p>
         ...
         * {@link com.ibm.cos.v2.services.s3.model.Transition.Builder} avoiding the need to create one manually
         * via {@link com.ibm.cos.v2.services.s3.model.Transition#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.Transition.Builder#build()} is called immediately and its
         * result is passed to {@link #transitions(List<Transition>)}.
         * 
         * @param transitions
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.Transition.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #transitions(java.util.Collection<Transition>)
         */
         ...
         *        storage class at a set period in the object's lifetime.</p> <note>
         *        <p>
         *        This parameter applies to general purpose buckets only. It is not supported for directory bucket
         *        lifecycle configurations.
         *        </p>
         ...
         * </p>
         * </note> This is a convenience method that creates an instance of the
         * {@link com.ibm.cos.v2.services.s3.model.NoncurrentVersionTransition.Builder} avoiding the need to
         * create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.NoncurrentVersionTransition#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.NoncurrentVersionTransition.Builder#build()} is called
         ...
         *        {@link com.ibm.cos.v2.services.s3.model.NoncurrentVersionTransition.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #noncurrentVersionTransitions(java.util.Collection<NoncurrentVersionTransition>)
         */
