...
/**
 * {@link GetBucketMetadataTableConfigurationRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class GetBucketMetadataTableConfigurationRequestMarshaller implements
        Marshaller<GetBucketMetadataTableConfigurationRequest> {
    ...
    public GetBucketMetadataTableConfigurationRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(GetBucketMetadataTableConfigurationRequest getBucketMetadataTableConfigurationRequest) {
        Validate.paramNotNull(getBucketMetadataTableConfigurationRequest, "getBucketMetadataTableConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketMetadataTableConfigurationRequest);
        } catch (Exception e) {
