...
public final class ListMultipartUploadsResponse extends S3Response implements
     ...
     *         only keys starting with the specified prefix.</p> <note>
     *         <p>
     ...
     *         this element is absent from the response.</p> <note>
     *         <p>
     *         <b>Directory buckets</b> - For directory buckets, <code>/</code> is the only supported delimiter.
     *         </p>
     */
     ...
     *         <code>upload-id-marker</code> request parameter in a subsequent request.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     */
     ...
     *         <code>Prefix</code> child element.</p> <note>
     *         <p>
     *         <b>Directory buckets</b> - For directory buckets, only prefixes that end in a delimiter (<code>/</code>)
     *         are supported.
     *         </p>
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("UploadIdMarker", UPLOAD_ID_MARKER_FIELD);
        map.put("NextKeyMarker", NEXT_KEY_MARKER_FIELD);
        map.put("Prefix", PREFIX_FIELD);
        map.put("Delimiter", DELIMITER_FIELD);
        map.put("NextUploadIdMarker", NEXT_UPLOAD_ID_MARKER_FIELD);
        map.put("MaxUploads", MAX_UPLOADS_FIELD);
        map.put("IsTruncated", IS_TRUNCATED_FIELD);
        map.put("Upload", UPLOADS_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, ListMultipartUploadsResponse> {
         ...
         *        contains only keys starting with the specified prefix.</p> <note>
         *        <p>
         ...
         * {@link com.ibm.cos.v2.services.s3.model.MultipartUpload.Builder} avoiding the need to create one
         * manually via {@link com.ibm.cos.v2.services.s3.model.MultipartUpload#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link com.ibm.cos.v2.services.s3.model.MultipartUpload.Builder#build()} is called immediately and
         * its result is passed to {@link #uploads(List<MultipartUpload>)}.
         * 
         * @param uploads
         *        a consumer that will call methods on
         *        {@link com.ibm.cos.v2.services.s3.model.MultipartUpload.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #uploads(java.util.Collection<MultipartUpload>)
         */
