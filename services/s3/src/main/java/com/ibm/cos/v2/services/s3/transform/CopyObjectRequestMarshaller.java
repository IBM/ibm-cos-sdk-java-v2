...
public class CopyObjectRequestMarshaller implements Marshaller<CopyObjectRequest> {
    ...
    public SdkHttpFullRequest marshall(CopyObjectRequest copyObjectRequest) {
        ...
        try {
            ...
            SdkHttpFullRequest request =  protocolMarshaller.marshall(copyObjectRequest);
            SdkHttpFullRequest.Builder builder = request.toBuilder();

            if (copyObjectRequest.retentionDirective() != null) {
                builder.putHeader(RETENTION_DIRECTIVE, copyObjectRequest.retentionDirective().toString());
            }
