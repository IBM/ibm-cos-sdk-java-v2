...
public final class UploadPartResponse extends S3Response implements
    ...
    private static final SdkField<String> CHECKSUM_CRC64_NVME_FIELD = SdkField
            ...
            .getter(getter(UploadPartResponse::checksumCRC64NVME))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(SERVER_SIDE_ENCRYPTION_FIELD,
            E_TAG_FIELD, CHECKSUM_CRC32_FIELD, CHECKSUM_CRC32_C_FIELD, CHECKSUM_CRC64_NVME_FIELD, CHECKSUM_SHA1_FIELD,
            CHECKSUM_SHA256_FIELD, SSE_CUSTOMER_ALGORITHM_FIELD, SSE_CUSTOMER_KEY_MD5_FIELD, SSEKMS_KEY_ID_FIELD,
    ...
    public final String toString() {
        return ToString.builder("UploadPartResponse").add("ServerSideEncryption", serverSideEncryptionAsString())
                ...
                .add("ChecksumSHA256", checksumSHA256()).add("SSECustomerAlgorithm", sseCustomerAlgorithm())
