...
public class ListLegalHoldsRequestMarshaller implements Marshaller<ListLegalHoldsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}/{Key+}?legalHold")
                                                                            ...
                                                                            .putAdditionalMetadata(AwsXmlProtocolFactory.ROOT_MARSHALL_LOCATION_ATTRIBUTE, "ListLegalHolds")
                                                                            .putAdditionalMetadata(AwsXmlProtocolFactory.XML_NAMESPACE_ATTRIBUTE, "http://s3.amazonaws.com/doc/2006-03-01/")
                                                                            .build();

    private final AwsXmlProtocolFactory protocolFactory;

    public ListLegalHoldsRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
    ...
    public SdkHttpFullRequest marshall(ListLegalHoldsRequest listLegalHoldsRequest) {
        ...
        Validate.paramNotNull(listLegalHoldsRequest, "ListLegalHoldsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                .createProtocolMarshaller(SDK_OPERATION_BINDING);

            return protocolMarshaller.marshall(listLegalHoldsRequest);
