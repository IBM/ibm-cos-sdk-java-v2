...
public final class LifecycleRuleAndOperator implements SdkPojo, Serializable,
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("Tag", TAGS_FIELD);
        map.put("ObjectSizeGreaterThan", OBJECT_SIZE_GREATER_THAN_FIELD);
        map.put("ObjectSizeLessThan", OBJECT_SIZE_LESS_THAN_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, LifecycleRuleAndOperator> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.Tag.Builder} avoiding the need to create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.Tag#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes, {@link com.ibm.cos.v2.services.s3.model.Tag.Builder#build()} is
         * called immediately and its result is passed to {@link #tags(List<Tag>)}.
         * 
         * @param tags
         *        a consumer that will call methods on {@link com.ibm.cos.v2.services.s3.model.Tag.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
