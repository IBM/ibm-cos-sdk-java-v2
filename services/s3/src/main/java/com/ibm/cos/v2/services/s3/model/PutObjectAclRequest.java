...
public final class PutObjectAclRequest extends S3Request implements
     ...
     * </p>
     * 
     * @return The Base64 encoded 128-bit <code>MD5</code> digest of the data. This header must be used as a message
     *         integrity check to verify that the request body was not corrupted in transit. For more information, go to
     *         <a href="http://www.ietf.org/rfc/rfc1864.txt">RFC 1864.&gt;</a> </p>
     *         <p>
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("AccessControlPolicy", ACCESS_CONTROL_POLICY_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutObjectAclRequest> {
        ...
        /**
         * <p>
         * The Base64 encoded 128-bit <code>MD5</code> digest of the data. This header must be used as a message
         * integrity check to verify that the request body was not corrupted in transit. For more information, go to <a
         * href="http://www.ietf.org/rfc/rfc1864.txt">RFC 1864.&gt;</a>
         * </p>
         * <p>
         * For requests made using the Amazon Web Services Command Line Interface (CLI) or Amazon Web Services SDKs,
         ...
         *        to <a href="http://www.ietf.org/rfc/rfc1864.txt">RFC 1864.&gt;</a> </p>
         *        <p>
