...
public final class GetObjectAttributesRequest extends S3Request implements
     ...
     * <code>null</code> value of the version ID is supported by directory buckets. You can only specify
     * <code>null</code> to the <code>versionId</code> query parameter in the request.
     * </p>
     * </note>
     * 
     * @return The version ID used to reference a specific version of the object.</p> <note>
     *         <p>
     *         S3 Versioning isn't enabled and supported for directory buckets. For this API operation, only the
     *         <code>null</code> value of the version ID is supported by directory buckets. You can only specify
     *         <code>null</code> to the <code>versionId</code> query parameter in the request.
     ...
     * </p>
     * 
     * @return Specifies the fields at the root level that you want returned in the response. Fields that you do not
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("x-amz-max-parts", MAX_PARTS_FIELD);
        map.put("x-amz-part-number-marker", PART_NUMBER_MARKER_FIELD);
        ...
        map.put("x-amz-object-attributes", OBJECT_ATTRIBUTES_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectAttributesRequest> {
         ...
         * 
         * @param versionId
         *        The version ID used to reference a specific version of the object.</p> <note>
         *        <p>
         *        S3 Versioning isn't enabled and supported for directory buckets. For this API operation, only the
         *        <code>null</code> value of the version ID is supported by directory buckets. You can only specify
         *        <code>null</code> to the <code>versionId</code> query parameter in the request.
