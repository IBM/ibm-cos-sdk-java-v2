...
public final class IntelligentTieringConfiguration implements SdkPojo, Serializable,
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("Tiering", TIERINGS_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, IntelligentTieringConfiguration> {
         ...
         * {@link com.ibm.cos.v2.services.s3.model.Tiering.Builder} avoiding the need to create one manually via
         * {@link com.ibm.cos.v2.services.s3.model.Tiering#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes, {@link com.ibm.cos.v2.services.s3.model.Tiering.Builder#build()}
         * is called immediately and its result is passed to {@link #tierings(List<Tiering>)}.
         * 
         * @param tierings
         *        a consumer that will call methods on {@link com.ibm.cos.v2.services.s3.model.Tiering.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #tierings(java.util.Collection<Tiering>)
         */
