...
@SdkInternalApi
public class ListBucketsExtendedRequestMarshaller implements Marshaller<ListBucketsExtendedRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/?extended")
    ...
    public ListBucketsExtendedRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(ListBucketsExtendedRequest listBucketsExtendedRequest) {
        {
            Validate.paramNotNull(listBucketsExtendedRequest, "listBucketsExtendedRequest");
            try {
                ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
                return protocolMarshaller.marshall(listBucketsExtendedRequest);
            } catch (Exception e) {
