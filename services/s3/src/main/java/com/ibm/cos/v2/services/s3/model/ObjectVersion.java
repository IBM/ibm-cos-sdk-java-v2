...
public final class ObjectVersion implements SdkPojo, Serializable, ToCopyableBuilder<ObjectVersion.Builder, ObjectVersion> {
    ...
    private static final SdkField<String> CHECKSUM_TYPE_FIELD = SdkField
            ...
            .getter(getter(ObjectVersion::checksumTypeAsString))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(E_TAG_FIELD,
            CHECKSUM_ALGORITHM_FIELD, CHECKSUM_TYPE_FIELD, SIZE_FIELD, STORAGE_CLASS_FIELD, KEY_FIELD, VERSION_ID_FIELD,
            IS_LATEST_FIELD, LAST_MODIFIED_FIELD, OWNER_FIELD, RESTORE_STATUS_FIELD));
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(eTag(), other.eTag()) && hasChecksumAlgorithm() == other.hasChecksumAlgorithm()
                ...
                && Objects.equals(storageClassAsString(), other.storageClassAsString()) && Objects.equals(key(), other.key())
                && Objects.equals(versionId(), other.versionId()) && Objects.equals(isLatest(), other.isLatest())
                && Objects.equals(lastModified(), other.lastModified()) && Objects.equals(owner(), other.owner())
    ...
    public final String toString() {
        return ToString.builder("ObjectVersion").add("ETag", eTag())
                ...
                .add("Key", key()).add("VersionId", versionId()).add("IsLatest", isLatest()).add("LastModified", lastModified())
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("IsLatest", IS_LATEST_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ObjectVersion> {
         ...
         * with archived objects</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * This is a convenience method that creates an instance of the {@link RestoreStatus.Builder} avoiding the need
         * to create one manually via {@link RestoreStatus#builder()}.
         *
         * <p>
