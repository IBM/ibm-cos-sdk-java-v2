...
public final class CopyObjectResponse extends S3Response implements
     ...
     * </note>
     * 
     * @return If the object expiration is configured, the response includes this header.</p> <note>
     *         <p>
     *         Object expiration information is not returned in directory buckets and this header returns the value "
     *         <code>NotImplemented</code>" in all responses for directory buckets.
     *         </p>
     ...
     * </note>
     * 
     * @return Version ID of the source object that was copied.</p> <note>
     *         <p>
     *         This functionality is not supported when the source object is in a directory bucket.
     *         </p>
     */
     ...
     * </note>
     * 
     * @return Version ID of the newly created copy.</p> <note>
     *         <p>
     *         This functionality is not supported for directory buckets.
     *         </p>
     */
     ...
     * </p>
     * 
     * @return Indicates whether the copied object uses an S3 Bucket Key for server-side encryption with Key Management
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("CopyObjectResult", COPY_OBJECT_RESULT_FIELD);
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, CopyObjectResponse> {
         ...
         * 
         * @param expiration
         *        If the object expiration is configured, the response includes this header.</p> <note>
         *        <p>
         *        Object expiration information is not returned in directory buckets and this header returns the value "
         *        <code>NotImplemented</code>" in all responses for directory buckets.
         *        </p>
         ...
         *        Version ID of the source object that was copied.</p> <note>
         *        <p>
         *        This functionality is not supported when the source object is in a directory bucket.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
         ...
         * 
         * @param versionId
         *        Version ID of the newly created copy.</p> <note>
         *        <p>
         *        This functionality is not supported for directory buckets.
         *        </p>
         * @return Returns a reference to this object so that method calls can be chained together.
