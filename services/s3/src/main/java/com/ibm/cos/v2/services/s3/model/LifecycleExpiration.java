...
public final class LifecycleExpiration implements SdkPojo, Serializable,
     ...
     * </note>
     * 
     * @return Indicates at what date the object is to be moved or deleted. The date value must conform to the ISO 8601
     *         format. The time is always midnight UTC.</p> <note>
     *         <p>
     ...
     *         Days or Date in a Lifecycle Expiration Policy.</p> <note>
     *         <p>
     *         This parameter applies to general purpose buckets only. It is not supported for directory bucket
     *         lifecycle configurations.
     *         </p>
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("ExpiredObjectDeleteMarker", EXPIRED_OBJECT_DELETE_MARKER_FIELD);
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, LifecycleExpiration> {
        /**
         * <p>
         * Indicates at what date the object is to be moved or deleted. The date value must conform to the ISO 8601
         ...
         *        8601 format. The time is always midnight UTC.</p> <note>
         *        <p>
         *        This parameter applies to general purpose buckets only. It is not supported for directory bucket
         *        lifecycle configurations.
         *        </p>
         ...
         *        specified with Days or Date in a Lifecycle Expiration Policy.</p> <note>
         *        <p>
         *        This parameter applies to general purpose buckets only. It is not supported for directory bucket
         *        lifecycle configurations.
         *        </p>
