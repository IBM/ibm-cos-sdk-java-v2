...
public final class GetBucketNotificationConfigurationRequest extends S3Request implements
     ...
     * </p>
     * 
     * @return The name of the bucket for which to get the notification configuration.</p>
     *         <p>
     *         When you use this API operation with an access point, provide the alias of the access point in place of
     *         the bucket name.
     *         </p>
     *         <p>
     ...
     *         not valid, the error code <code>InvalidAccessPointAliasError</code> is returned. For more information
    ...
    public interface Builder extends S3Request.Builder, SdkPojo,
         ...
         * access point in place of the bucket name. If the Object Lambda access point alias in a request is not valid,
         * the error code <code>InvalidAccessPointAliasError</code> is returned. For more information about
         * <code>InvalidAccessPointAliasError</code>, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html#ErrorCodeList">List of Error
         * Codes</a>.
         * </p>
         * 
         * @param bucket
         *        The name of the bucket for which to get the notification configuration.</p>
         *        <p>
         ...
         *        <p>
         *        When you use this API operation with an Object Lambda access point, provide the alias of the Object
         *        Lambda access point in place of the bucket name. If the Object Lambda access point alias in a request
         *        is not valid, the error code <code>InvalidAccessPointAliasError</code> is returned. For more
