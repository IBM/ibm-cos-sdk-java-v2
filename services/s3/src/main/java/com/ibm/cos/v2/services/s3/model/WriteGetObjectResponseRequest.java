...
public final class WriteGetObjectResponseRequest extends S3Request implements
    ...
    private static final SdkField<String> REQUEST_ROUTE_FIELD = SdkField
            ...
            .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-route")
                    .unmarshallLocationName("x-amz-request-route").build(), RequiredTrait.create()).build();
    ...
    private static final SdkField<String> REQUEST_TOKEN_FIELD = SdkField
            ...
            .traits(LocationTrait.builder().location(MarshallLocation.HEADER).locationName("x-amz-request-token")
                    .unmarshallLocationName("x-amz-request-token").build(), RequiredTrait.create()).build();
    ...
    private static final SdkField<String> CHECKSUM_CRC64_NVME_FIELD = SdkField
            ...
            .getter(getter(WriteGetObjectResponseRequest::checksumCRC64NVME))
            .setter(setter(Builder::checksumCRC64NVME))
            .traits(LocationTrait.builder().location(MarshallLocation.HEADER)
                    .locationName("x-amz-fwd-header-x-amz-checksum-crc64nvme")
                    .unmarshallLocationName("x-amz-fwd-header-x-amz-checksum-crc64nvme").build()).build();
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(REQUEST_ROUTE_FIELD,
            ...
            CONTENT_RANGE_FIELD, CONTENT_TYPE_FIELD, CHECKSUM_CRC32_FIELD, CHECKSUM_CRC32_C_FIELD, CHECKSUM_CRC64_NVME_FIELD,
            CHECKSUM_SHA1_FIELD, CHECKSUM_SHA256_FIELD, DELETE_MARKER_FIELD, E_TAG_FIELD, EXPIRES_FIELD, EXPIRATION_FIELD,
            LAST_MODIFIED_FIELD, MISSING_META_FIELD, METADATA_FIELD, OBJECT_LOCK_MODE_FIELD, OBJECT_LOCK_LEGAL_HOLD_STATUS_FIELD,
     ...
     * </ul>
     * 
     * @return The integer status code for an HTTP response of a corresponding <code>GetObject</code> request. The
     ...
     *         was originally sent. This specifies the Base64 encoded, 32-bit <code>CRC32</code> checksum of the object
     *         returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon
     *         S3. Amazon S3 will perform validation of the checksum values only when the original
     *         <code>GetObject</code> request required checksum validation. For more information about checksums, see <a
     ...
     * 
     * @return This header can be used as a data integrity check to verify that the data received is the same data that
     *         was originally sent. This specifies the Base64 encoded, 32-bit <code>CRC32C</code> checksum of the object
     *         returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon
     *         S3. Amazon S3 will perform validation of the checksum values only when the original
     *         <code>GetObject</code> request required checksum validation. For more information about checksums, see <a
     *         href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
     ...
     *         the part. For more information, see <a
     *         href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
     *         object integrity</a> in the <i>Amazon S3 User Guide</i>.
     */
     ...
     * 
     * @return This header can be used as a data integrity check to verify that the data received is the same data that
     *         was originally sent. This specifies the Base64 encoded, 160-bit <code>SHA1</code> digest of the object
     *         returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon
     *         S3. Amazon S3 will perform validation of the checksum values only when the original
     *         <code>GetObject</code> request required checksum validation. For more information about checksums, see <a
     *         href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
     ...
     * 
     * @return This header can be used as a data integrity check to verify that the data received is the same data that
     *         was originally sent. This specifies the Base64 encoded, 256-bit <code>SHA256</code> digest of the object
     *         returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon
     *         S3. Amazon S3 will perform validation of the checksum values only when the original
     *         <code>GetObject</code> request required checksum validation. For more information about checksums, see <a
     *         href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
     ...
     *         delete marker. To learn more about delete markers, see <a
     ...
     * </p>
     * 
     * @return If present, specifies the ID (Key ID, Key ARN, or Key Alias) of the Amazon Web Services Key Management
     *         Service (Amazon Web Services KMS) symmetric encryption customer managed key that was used for stored in
     *         Amazon S3 object.
     */
    ...
    public final String toString() {
        return ToString.builder("WriteGetObjectResponseRequest").add("RequestRoute", requestRoute())
                ...
                .add("ChecksumSHA1", checksumSHA1()).add("ChecksumSHA256", checksumSHA256()).add("DeleteMarker", deleteMarker())
                .add("ETag", eTag()).add("Expires", expires()).add("Expiration", expiration())
                .add("LastModified", lastModified()).add("MissingMeta", missingMeta())
                .add("Metadata", hasMetadata() ? metadata() : null).add("ObjectLockMode", objectLockModeAsString())
    ...
    private static Map<String, SdkField<?>> memberNameToFieldInitializer() {
        ...
        map.put("x-amz-request-route", REQUEST_ROUTE_FIELD);
        map.put("x-amz-request-token", REQUEST_TOKEN_FIELD);
        map.put("x-amz-fwd-status", STATUS_CODE_FIELD);
        map.put("x-amz-fwd-error-code", ERROR_CODE_FIELD);
        map.put("x-amz-fwd-error-message", ERROR_MESSAGE_FIELD);
        map.put("x-amz-fwd-header-accept-ranges", ACCEPT_RANGES_FIELD);
        map.put("x-amz-fwd-header-Cache-Control", CACHE_CONTROL_FIELD);
        map.put("x-amz-fwd-header-Content-Disposition", CONTENT_DISPOSITION_FIELD);
        map.put("x-amz-fwd-header-Content-Encoding", CONTENT_ENCODING_FIELD);
        map.put("x-amz-fwd-header-Content-Language", CONTENT_LANGUAGE_FIELD);
        map.put("Content-Length", CONTENT_LENGTH_FIELD);
        map.put("x-amz-fwd-header-Content-Range", CONTENT_RANGE_FIELD);
        map.put("x-amz-fwd-header-Content-Type", CONTENT_TYPE_FIELD);
        map.put("x-amz-fwd-header-x-amz-checksum-crc32", CHECKSUM_CRC32_FIELD);
        map.put("x-amz-fwd-header-x-amz-checksum-crc32c", CHECKSUM_CRC32_C_FIELD);
        map.put("x-amz-fwd-header-x-amz-checksum-crc64nvme", CHECKSUM_CRC64_NVME_FIELD);
        map.put("x-amz-fwd-header-x-amz-checksum-sha1", CHECKSUM_SHA1_FIELD);
        map.put("x-amz-fwd-header-x-amz-checksum-sha256", CHECKSUM_SHA256_FIELD);
        map.put("x-amz-fwd-header-x-amz-delete-marker", DELETE_MARKER_FIELD);
        map.put("x-amz-fwd-header-ETag", E_TAG_FIELD);
        map.put("x-amz-fwd-header-Expires", EXPIRES_FIELD);
        map.put("x-amz-fwd-header-x-amz-expiration", EXPIRATION_FIELD);
        map.put("x-amz-fwd-header-Last-Modified", LAST_MODIFIED_FIELD);
        map.put("x-amz-fwd-header-x-amz-missing-meta", MISSING_META_FIELD);
        map.put("x-amz-meta-", METADATA_FIELD);
        map.put("x-amz-fwd-header-x-amz-object-lock-mode", OBJECT_LOCK_MODE_FIELD);
        map.put("x-amz-fwd-header-x-amz-object-lock-legal-hold", OBJECT_LOCK_LEGAL_HOLD_STATUS_FIELD);
        map.put("x-amz-fwd-header-x-amz-object-lock-retain-until-date", OBJECT_LOCK_RETAIN_UNTIL_DATE_FIELD);
        map.put("x-amz-fwd-header-x-amz-mp-parts-count", PARTS_COUNT_FIELD);
        map.put("x-amz-fwd-header-x-amz-replication-status", REPLICATION_STATUS_FIELD);
        map.put("x-amz-fwd-header-x-amz-request-charged", REQUEST_CHARGED_FIELD);
        map.put("x-amz-fwd-header-x-amz-restore", RESTORE_FIELD);
        map.put("x-amz-fwd-header-x-amz-server-side-encryption", SERVER_SIDE_ENCRYPTION_FIELD);
        map.put("x-amz-fwd-header-x-amz-server-side-encryption-customer-algorithm", SSE_CUSTOMER_ALGORITHM_FIELD);
        map.put("x-amz-fwd-header-x-amz-server-side-encryption-aws-kms-key-id", SSEKMS_KEY_ID_FIELD);
        map.put("x-amz-fwd-header-x-amz-server-side-encryption-customer-key-MD5", SSE_CUSTOMER_KEY_MD5_FIELD);
        map.put("x-amz-fwd-header-x-amz-storage-class", STORAGE_CLASS_FIELD);
        map.put("x-amz-fwd-header-x-amz-tagging-count", TAG_COUNT_FIELD);
        map.put("x-amz-fwd-header-x-amz-version-id", VERSION_ID_FIELD);
        map.put("x-amz-fwd-header-x-amz-server-side-encryption-bucket-key-enabled", BUCKET_KEY_ENABLED_FIELD);
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, WriteGetObjectResponseRequest> {
        ...
        /**
         * <p>
         * The integer status code for an HTTP response of a corresponding <code>GetObject</code> request. The following
         ...
         * 
         * @param statusCode
         *        The integer status code for an HTTP response of a corresponding <code>GetObject</code> request. The
         *        following is a list of status codes.</p>
         *        <ul>
         *        <li>
         *        <p>
         ...
         * <p>
         * This header can be used as a data integrity check to verify that the data received is the same data that was
         * originally sent. This specifies the Base64 encoded, 32-bit <code>CRC32</code> checksum of the object returned
         * by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3. Amazon S3
         * will perform validation of the checksum values only when the original <code>GetObject</code> request required
         ...
         *        object returned by the Object Lambda function. This may not match the checksum for the object stored
         *        in Amazon S3. Amazon S3 will perform validation of the checksum values only when the original
         ...
         * <p>
         * This header can be used as a data integrity check to verify that the data received is the same data that was
         * originally sent. This specifies the Base64 encoded, 32-bit <code>CRC32C</code> checksum of the object
         * returned by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3.
         * Amazon S3 will perform validation of the checksum values only when the original <code>GetObject</code>
         * request required checksum validation. For more information about checksums, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object
         * integrity</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * <p>
         ...
         *        This header can be used as a data integrity check to verify that the data received is the same data
         *        that was originally sent. This specifies the Base64 encoded, 32-bit <code>CRC32C</code> checksum of
         *        the object returned by the Object Lambda function. This may not match the checksum for the object
         ...
         * part. For more information, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object
         * integrity</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * 
         ...
         *        checksum of the part. For more information, see <a
         *        href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
         *        object integrity</a> in the <i>Amazon S3 User Guide</i>.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
         ...
         * <p>
         * This header can be used as a data integrity check to verify that the data received is the same data that was
         * originally sent. This specifies the Base64 encoded, 160-bit <code>SHA1</code> digest of the object returned
         * by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3. Amazon S3
         * will perform validation of the checksum values only when the original <code>GetObject</code> request required
         * checksum validation. For more information about checksums, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object
         ...
         * <p>
         * This header can be used as a data integrity check to verify that the data received is the same data that was
         * originally sent. This specifies the Base64 encoded, 256-bit <code>SHA256</code> digest of the object returned
         * by the Object Lambda function. This may not match the checksum for the object stored in Amazon S3. Amazon S3
         * will perform validation of the checksum values only when the original <code>GetObject</code> request required
         * checksum validation. For more information about checksums, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object
         ...
         *        a delete marker. To learn more about delete markers, see <a
         *        href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeleteMarker.html">Working with delete
         *        markers</a>.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
        ...
        /**
         * <p>
         * If present, specifies the ID (Key ID, Key ARN, or Key Alias) of the Amazon Web Services Key Management
         * Service (Amazon Web Services KMS) symmetric encryption customer managed key that was used for stored in
         * Amazon S3 object.
         * </p>
         * 
         * @param ssekmsKeyId
         *        If present, specifies the ID (Key ID, Key ARN, or Key Alias) of the Amazon Web Services Key Management
         *        Service (Amazon Web Services KMS) symmetric encryption customer managed key that was used for stored
         *        in Amazon S3 object.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
