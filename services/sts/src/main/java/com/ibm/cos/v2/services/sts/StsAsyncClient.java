...
import com.ibm.cos.v2.awscore.AwsClient;
...
/**
 * Service client for accessing AWS STS asynchronously. This can be created using the static {@link #builder()}
...
@SdkPublicApi
@ThreadSafe
public interface StsAsyncClient extends AwsClient {
    String SERVICE_NAME = "sts";

    /**
     * Value for looking up the service's metadata from the
     * {@link com.ibm.cos.v2.regions.ServiceMetadataProvider}.
     */
    String SERVICE_METADATA_ID = "sts";
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link AssumeRoleRequest.Builder} avoiding the need to
     * create one manually via {@link AssumeRoleRequest#builder()}
     * </p>
     *
     * @param assumeRoleRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.AssumeRoleRequest.Builder} to create a request.
     * @return A Java Future containing the result of the AssumeRole operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     ...
     *      Documentation</a>
     */
    default CompletableFuture<AssumeRoleResponse> assumeRole(Consumer<AssumeRoleRequest.Builder> assumeRoleRequest) {
        return assumeRole(AssumeRoleRequest.builder().applyMutation(assumeRoleRequest).build());
    }
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link AssumeRoleWithSamlRequest.Builder} avoiding the
     * need to create one manually via {@link AssumeRoleWithSamlRequest#builder()}
     * </p>
     *
     * @param assumeRoleWithSamlRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.AssumeRoleWithSamlRequest.Builder} to create a request.
     * @return A Java Future containing the result of the AssumeRoleWithSAML operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     ...
     *      Documentation</a>
     */
    default CompletableFuture<AssumeRoleWithSamlResponse> assumeRoleWithSAML(
            Consumer<AssumeRoleWithSamlRequest.Builder> assumeRoleWithSamlRequest) {
        return assumeRoleWithSAML(AssumeRoleWithSamlRequest.builder().applyMutation(assumeRoleWithSamlRequest).build());
    }
     ...
     *      API Documentation</a>
     */
    default CompletableFuture<AssumeRoleWithWebIdentityResponse> assumeRoleWithWebIdentity(
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link AssumeRoleWithWebIdentityRequest.Builder} avoiding
     * the need to create one manually via {@link AssumeRoleWithWebIdentityRequest#builder()}
     * </p>
     *
     * @param assumeRoleWithWebIdentityRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.AssumeRoleWithWebIdentityRequest.Builder} to create a
     *        request.
     * @return A Java Future containing the result of the AssumeRoleWithWebIdentity operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     ...
     */
    default CompletableFuture<AssumeRoleWithWebIdentityResponse> assumeRoleWithWebIdentity(
            Consumer<AssumeRoleWithWebIdentityRequest.Builder> assumeRoleWithWebIdentityRequest) {
        return assumeRoleWithWebIdentity(AssumeRoleWithWebIdentityRequest.builder()
                .applyMutation(assumeRoleWithWebIdentityRequest).build());
    }
     ...
     *      Documentation</a>
     */
    default CompletableFuture<AssumeRootResponse> assumeRoot(AssumeRootRequest assumeRootRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link AssumeRootRequest.Builder} avoiding the need to
     * create one manually via {@link AssumeRootRequest#builder()}
     * </p>
     *
     * @param assumeRootRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.AssumeRootRequest.Builder} to create a request.
     * @return A Java Future containing the result of the AssumeRoot operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     ...
     *      Documentation</a>
     */
    default CompletableFuture<AssumeRootResponse> assumeRoot(Consumer<AssumeRootRequest.Builder> assumeRootRequest) {
        return assumeRoot(AssumeRootRequest.builder().applyMutation(assumeRootRequest).build());
    }
     ...
     */
    default CompletableFuture<DecodeAuthorizationMessageResponse> decodeAuthorizationMessage(
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link DecodeAuthorizationMessageRequest.Builder} avoiding
     * the need to create one manually via {@link DecodeAuthorizationMessageRequest#builder()}
     * </p>
     *
     * @param decodeAuthorizationMessageRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.DecodeAuthorizationMessageRequest.Builder} to create a
     *        request.
     * @return A Java Future containing the result of the DecodeAuthorizationMessage operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     ...
     */
    default CompletableFuture<DecodeAuthorizationMessageResponse> decodeAuthorizationMessage(
            Consumer<DecodeAuthorizationMessageRequest.Builder> decodeAuthorizationMessageRequest) {
        return decodeAuthorizationMessage(DecodeAuthorizationMessageRequest.builder()
                .applyMutation(decodeAuthorizationMessageRequest).build());
    }
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link GetAccessKeyInfoRequest.Builder} avoiding the need
     * to create one manually via {@link GetAccessKeyInfoRequest#builder()}
     * </p>
     *
     * @param getAccessKeyInfoRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.GetAccessKeyInfoRequest.Builder} to create a request.
     * @return A Java Future containing the result of the GetAccessKeyInfo operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     ...
     *      Documentation</a>
     */
    default CompletableFuture<GetAccessKeyInfoResponse> getAccessKeyInfo(
            Consumer<GetAccessKeyInfoRequest.Builder> getAccessKeyInfoRequest) {
        return getAccessKeyInfo(GetAccessKeyInfoRequest.builder().applyMutation(getAccessKeyInfoRequest).build());
    }
     ...
     * </note><br/>
     * <p>
     * This is a convenience which creates an instance of the {@link GetCallerIdentityRequest.Builder} avoiding the need
     * to create one manually via {@link GetCallerIdentityRequest#builder()}
     * </p>
     *
     * @param getCallerIdentityRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.GetCallerIdentityRequest.Builder} to create a request.
     * @return A Java Future containing the result of the GetCallerIdentity operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
    ...
    default CompletableFuture<GetCallerIdentityResponse> getCallerIdentity(
            Consumer<GetCallerIdentityRequest.Builder> getCallerIdentityRequest) {
        return getCallerIdentity(GetCallerIdentityRequest.builder().applyMutation(getCallerIdentityRequest).build());
    }
     ...
     * @param getFederationTokenRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.GetFederationTokenRequest.Builder} to create a request.
     * @return A Java Future containing the result of the GetFederationToken operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     ...
     * <br/>
     * <p>
     * This is a convenience which creates an instance of the {@link GetSessionTokenRequest.Builder} avoiding the need
     * to create one manually via {@link GetSessionTokenRequest#builder()}
     * </p>
     *
     * @param getSessionTokenRequest
     *        A {@link Consumer} that will call methods on
     *        {@link com.ibm.cos.v2.services.sts.model.GetSessionTokenRequest.Builder} to create a request.
     * @return A Java Future containing the result of the GetSessionToken operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
    ...
    default CompletableFuture<GetSessionTokenResponse> getSessionToken(
            Consumer<GetSessionTokenRequest.Builder> getSessionTokenRequest) {
        return getSessionToken(GetSessionTokenRequest.builder().applyMutation(getSessionTokenRequest).build());
    }
     ...
     */
    default CompletableFuture<GetSessionTokenResponse> getSessionToken() {
        return getSessionToken(GetSessionTokenRequest.builder().build());
    }

    @Override
    default StsServiceClientConfiguration serviceClientConfiguration() {
        throw new UnsupportedOperationException();
    }

    /**
     * Create a {@link StsAsyncClient} with the region loaded from the
     * {@link com.ibm.cos.v2.regions.providers.DefaultAwsRegionProviderChain} and credentials loaded from the
     * {@link com.ibm.cos.v2.auth.credentials.DefaultCredentialsProvider}.
     */
    ...
    /**
     * Create a builder that can be used to configure and create a {@link StsAsyncClient}.
     */
