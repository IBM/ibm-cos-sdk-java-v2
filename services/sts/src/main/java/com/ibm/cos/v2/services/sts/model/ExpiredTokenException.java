...
public final class ExpiredTokenException extends StsException implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ExpiredTokenException>, StsException.Builder {
        @Override
