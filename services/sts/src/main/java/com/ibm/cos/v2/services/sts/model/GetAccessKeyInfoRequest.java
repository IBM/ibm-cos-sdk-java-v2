...
public final class GetAccessKeyInfoRequest extends StsRequest implements
        ToCopyableBuilder<GetAccessKeyInfoRequest.Builder, GetAccessKeyInfoRequest> {
    private static final SdkField<String> ACCESS_KEY_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("AccessKeyId").getter(getter(GetAccessKeyInfoRequest::accessKeyId)).setter(setter(Builder::accessKeyId))
    ...
    public final String toString() {
        return ToString.builder("GetAccessKeyInfoRequest").add("AccessKeyId", accessKeyId()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetAccessKeyInfoRequest, T> g) {
        return obj -> g.apply((GetAccessKeyInfoRequest) obj);
    }
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends StsRequest.Builder, SdkPojo, CopyableBuilder<Builder, GetAccessKeyInfoRequest> {
        /**
         * <p>
         * The identifier of an access key.
         * </p>
