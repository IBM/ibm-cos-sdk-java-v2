...
/**
 * {@link AssumeRoleRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class AssumeRoleRequestMarshaller implements Marshaller<AssumeRoleRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .operationIdentifier("AssumeRole").apiVersion("2011-06-15").build();
    ...
    public SdkHttpFullRequest marshall(AssumeRoleRequest assumeRoleRequest) {
        Validate.paramNotNull(assumeRoleRequest, "assumeRoleRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(assumeRoleRequest);
        } catch (Exception e) {
