...
public final class StsServiceClientConfiguration extends AwsServiceClientConfiguration {
    ...
    public static Builder builder() {
        return new StsServiceClientConfigurationBuilder();
    }
    ...
    /**
     * A builder for creating a {@link StsServiceClientConfiguration}
     */
    public interface Builder extends AwsServiceClientConfiguration.Builder {
         ...
         */
        Builder authSchemeProvider(StsAuthSchemeProvider authSchemeProvider);

        /**
         * Gets the value for auth scheme provider
         */
        StsAuthSchemeProvider authSchemeProvider();
