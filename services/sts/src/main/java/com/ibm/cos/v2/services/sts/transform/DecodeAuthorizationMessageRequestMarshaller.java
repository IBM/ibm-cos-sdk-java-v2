...
/**
 * {@link DecodeAuthorizationMessageRequest} Marshaller
 */
...
public class DecodeAuthorizationMessageRequestMarshaller implements Marshaller<DecodeAuthorizationMessageRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .operationIdentifier("DecodeAuthorizationMessage").apiVersion("2011-06-15").build();
    ...
    public SdkHttpFullRequest marshall(DecodeAuthorizationMessageRequest decodeAuthorizationMessageRequest) {
        ...
        try {
            ...
            return protocolMarshaller.marshall(decodeAuthorizationMessageRequest);
        } catch (Exception e) {
