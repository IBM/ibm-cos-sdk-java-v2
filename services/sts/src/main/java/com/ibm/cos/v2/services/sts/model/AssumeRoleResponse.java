...
public final class AssumeRoleResponse extends StsResponse implements
    ...
    private static final SdkField<Credentials> CREDENTIALS_FIELD = SdkField.<Credentials> builder(MarshallingType.SDK_POJO)
            .memberName("Credentials").getter(getter(AssumeRoleResponse::credentials)).setter(setter(Builder::credentials))
    ...
    private static final SdkField<AssumedRoleUser> ASSUMED_ROLE_USER_FIELD = SdkField
            ...
            .getter(getter(AssumeRoleResponse::assumedRoleUser)).setter(setter(Builder::assumedRoleUser))
    ...
    private static final SdkField<Integer> PACKED_POLICY_SIZE_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("PackedPolicySize").getter(getter(AssumeRoleResponse::packedPolicySize))
    ...
    private static final SdkField<String> SOURCE_IDENTITY_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("SourceIdentity").getter(getter(AssumeRoleResponse::sourceIdentity))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(CREDENTIALS_FIELD,
            ASSUMED_ROLE_USER_FIELD, PACKED_POLICY_SIZE_FIELD, SOURCE_IDENTITY_FIELD));
    ...
    public final String toString() {
        return ToString.builder("AssumeRoleResponse").add("Credentials", credentials()).add("AssumedRoleUser", assumedRoleUser())
                .add("PackedPolicySize", packedPolicySize()).add("SourceIdentity", sourceIdentity()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<AssumeRoleResponse, T> g) {
        return obj -> g.apply((AssumeRoleResponse) obj);
    }
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends StsResponse.Builder, SdkPojo, CopyableBuilder<Builder, AssumeRoleResponse> {
        /**
         * <p>
         * The temporary security credentials, which include an access key ID, a secret access key, and a security (or
         * session) token.
         ...
         * <p>
         * You can require users to specify a source identity when they assume a role. You do this by using the
         * <code>sts:SourceIdentity</code> condition key in a role trust policy. You can use source identity information
         * in CloudTrail logs to determine who took actions with a role. You can use the <code>aws:SourceIdentity</code>
         * condition key to further control access to Amazon Web Services resources based on the value of source
