...
/**
 * Internal implementation of {@link StsClient}.
 *
 * @see StsClient#builder()
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
final class DefaultStsClient implements StsClient {
    ...
    public AssumeRoleResponse assumeRole(AssumeRoleRequest assumeRoleRequest) throws MalformedPolicyDocumentException,
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<AssumeRoleRequest, AssumeRoleResponse>()
                    .withOperationName("AssumeRole").withProtocolMetadata(protocolMetadata).withResponseHandler(responseHandler)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.AssumeRoleWithSAML
    ...
    public AssumeRoleWithSamlResponse assumeRoleWithSAML(AssumeRoleWithSamlRequest assumeRoleWithSamlRequest)
            throws MalformedPolicyDocumentException, PackedPolicyTooLargeException, IdpRejectedClaimException,
            InvalidIdentityTokenException, ExpiredTokenException, RegionDisabledException, AwsServiceException,
            SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<AssumeRoleWithSamlRequest, AssumeRoleWithSamlResponse>()
                    .withOperationName("AssumeRoleWithSAML").withProtocolMetadata(protocolMetadata)
                    .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                    .withRequestConfiguration(clientConfiguration).withInput(assumeRoleWithSamlRequest)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.AssumeRoleWithWebIdentity
    ...
    public AssumeRoleWithWebIdentityResponse assumeRoleWithWebIdentity(
            AssumeRoleWithWebIdentityRequest assumeRoleWithWebIdentityRequest) throws MalformedPolicyDocumentException,
            PackedPolicyTooLargeException, IdpRejectedClaimException, IdpCommunicationErrorException,
            InvalidIdentityTokenException, ExpiredTokenException, RegionDisabledException, AwsServiceException,
            SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler
                    .execute(new ClientExecutionParams<AssumeRoleWithWebIdentityRequest, AssumeRoleWithWebIdentityResponse>()
                            ...
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withInput(assumeRoleWithWebIdentityRequest)
                            .withMetricCollector(apiCallMetricCollector)
     ...
     * @return Result of the AssumeRoot operation returned by the service.
     * @throws RegionDisabledException
     *         STS is not activated in the requested region for the account that is being asked to generate credentials.
     *         The account administrator must use the IAM console to activate STS in that region. For more information,
     *         see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.AssumeRoot
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public AssumeRootResponse assumeRoot(AssumeRootRequest assumeRootRequest) throws RegionDisabledException,
            ExpiredTokenException, AwsServiceException, SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<AssumeRootRequest, AssumeRootResponse>()
                    .withOperationName("AssumeRoot").withProtocolMetadata(protocolMetadata).withResponseHandler(responseHandler)
                    .withErrorResponseHandler(errorResponseHandler).withRequestConfiguration(clientConfiguration)
                    .withInput(assumeRootRequest).withMetricCollector(apiCallMetricCollector)
     ...
     *         happen if the token contains invalid characters, such as line breaks, or if the message has expired.
     * @throws SdkException
     *         Base class for all exceptions that can be thrown by the SDK (both service and client). Can be used for
     *         catch all scenarios.
     * @throws SdkClientException
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.DecodeAuthorizationMessage
    ...
    public DecodeAuthorizationMessageResponse decodeAuthorizationMessage(
            DecodeAuthorizationMessageRequest decodeAuthorizationMessageRequest) throws InvalidAuthorizationMessageException,
        ...
        try {
            ...
            return clientHandler
                    .execute(new ClientExecutionParams<DecodeAuthorizationMessageRequest, DecodeAuthorizationMessageResponse>()
                            ...
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withInput(decodeAuthorizationMessageRequest)
                            .withMetricCollector(apiCallMetricCollector)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.GetAccessKeyInfo
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetAccessKeyInfo" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public GetAccessKeyInfoResponse getAccessKeyInfo(GetAccessKeyInfoRequest getAccessKeyInfoRequest) throws AwsServiceException,
            SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<GetAccessKeyInfoRequest, GetAccessKeyInfoResponse>()
                    .withOperationName("GetAccessKeyInfo").withProtocolMetadata(protocolMetadata)
                    .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                    .withRequestConfiguration(clientConfiguration).withInput(getAccessKeyInfoRequest)
                    .withMetricCollector(apiCallMetricCollector)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.GetCallerIdentity
    ...
    public GetCallerIdentityResponse getCallerIdentity(GetCallerIdentityRequest getCallerIdentityRequest)
            throws AwsServiceException, SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<GetCallerIdentityRequest, GetCallerIdentityResponse>()
                    .withOperationName("GetCallerIdentity").withProtocolMetadata(protocolMetadata)
                    .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                    .withRequestConfiguration(clientConfiguration).withInput(getCallerIdentityRequest)
                    .withMetricCollector(apiCallMetricCollector)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.GetFederationToken
    ...
    public GetFederationTokenResponse getFederationToken(GetFederationTokenRequest getFederationTokenRequest)
            throws MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException, AwsServiceException,
            SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<GetFederationTokenRequest, GetFederationTokenResponse>()
                    ...
                    .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                    .withRequestConfiguration(clientConfiguration).withInput(getFederationTokenRequest)
                    .withMetricCollector(apiCallMetricCollector)
     ...
     * @throws StsException
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.GetSessionToken
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetSessionToken" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public GetSessionTokenResponse getSessionToken(GetSessionTokenRequest getSessionTokenRequest) throws RegionDisabledException,
            AwsServiceException, SdkClientException, StsException {
        ...
        try {
            ...
            return clientHandler.execute(new ClientExecutionParams<GetSessionTokenRequest, GetSessionTokenResponse>()
                    .withOperationName("GetSessionToken").withProtocolMetadata(protocolMetadata)
                    .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                    .withRequestConfiguration(clientConfiguration).withInput(getSessionTokenRequest)
                    .withMetricCollector(apiCallMetricCollector)
