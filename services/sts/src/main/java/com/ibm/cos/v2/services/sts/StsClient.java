...
/**
 * Service client for accessing AWS STS. This can be created using the static {@link #builder()} method.
 *
...
@SdkPublicApi
@ThreadSafe
public interface StsClient extends AwsClient {
     ...
     *      Documentation</a>
     */
    default AssumeRoleResponse assumeRole(AssumeRoleRequest assumeRoleRequest) throws MalformedPolicyDocumentException,
     ...
     *      Documentation</a>
     */
    default AssumeRoleResponse assumeRole(Consumer<AssumeRoleRequest.Builder> assumeRoleRequest)
            throws MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException,
     ...
     *      Documentation</a>
     */
    default AssumeRoleWithSamlResponse assumeRoleWithSAML(Consumer<AssumeRoleWithSamlRequest.Builder> assumeRoleWithSamlRequest)
            throws MalformedPolicyDocumentException, PackedPolicyTooLargeException, IdpRejectedClaimException,
            InvalidIdentityTokenException, ExpiredTokenException, RegionDisabledException, AwsServiceException,
            SdkClientException, StsException {
     ...
     *      API Documentation</a>
     */
    default AssumeRoleWithWebIdentityResponse assumeRoleWithWebIdentity(
     ...
     *      Documentation</a>
     */
    default AssumeRootResponse assumeRoot(AssumeRootRequest assumeRootRequest) throws RegionDisabledException,
            ExpiredTokenException, AwsServiceException, SdkClientException, StsException {
        throw new UnsupportedOperationException();
    }
     ...
     *      Documentation</a>
     */
    default AssumeRootResponse assumeRoot(Consumer<AssumeRootRequest.Builder> assumeRootRequest) throws RegionDisabledException,
            ExpiredTokenException, AwsServiceException, SdkClientException, StsException {
     ...
     */
    default DecodeAuthorizationMessageResponse decodeAuthorizationMessage(
    ...
    default DecodeAuthorizationMessageResponse decodeAuthorizationMessage(
            ...
            throws InvalidAuthorizationMessageException, AwsServiceException, SdkClientException, StsException {
     ...
     *      Documentation</a>
     */
    default GetAccessKeyInfoResponse getAccessKeyInfo(GetAccessKeyInfoRequest getAccessKeyInfoRequest)
     ...
     *      Documentation</a>
     */
    default GetAccessKeyInfoResponse getAccessKeyInfo(Consumer<GetAccessKeyInfoRequest.Builder> getAccessKeyInfoRequest)
            throws AwsServiceException, SdkClientException, StsException {
     ...
     *      Documentation</a>
     */
    default GetCallerIdentityResponse getCallerIdentity(GetCallerIdentityRequest getCallerIdentityRequest)
            throws AwsServiceException, SdkClientException, StsException {
        throw new UnsupportedOperationException();
    }
     ...
     *      Documentation</a>
     */
    default GetCallerIdentityResponse getCallerIdentity(Consumer<GetCallerIdentityRequest.Builder> getCallerIdentityRequest)
            throws AwsServiceException, SdkClientException, StsException {
     ...
     *         Base class for all service exceptions. Unknown exceptions will be thrown as an instance of this type.
     * @sample StsClient.GetCallerIdentity
     * @see #getCallerIdentity(GetCallerIdentityRequest)
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetCallerIdentity" target="_top">AWS API
     *      Documentation</a>
     */
     ...
     *      Documentation</a>
     */
    default GetSessionTokenResponse getSessionToken(GetSessionTokenRequest getSessionTokenRequest)
            throws RegionDisabledException, AwsServiceException, SdkClientException, StsException {
        throw new UnsupportedOperationException();
    }
     ...
     *      Documentation</a>
     */
    default GetSessionTokenResponse getSessionToken(Consumer<GetSessionTokenRequest.Builder> getSessionTokenRequest)
            throws RegionDisabledException, AwsServiceException, SdkClientException, StsException {
     ...
     *      Documentation</a>
     */
    default GetSessionTokenResponse getSessionToken() throws RegionDisabledException, AwsServiceException, SdkClientException,
            StsException {
        return getSessionToken(GetSessionTokenRequest.builder().build());
    }

    /**
     * Create a {@link StsClient} with the region loaded from the
    ...
    /**
     * Create a builder that can be used to configure and create a {@link StsClient}.
     */
