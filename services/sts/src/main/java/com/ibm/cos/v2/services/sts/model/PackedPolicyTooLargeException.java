...
public final class PackedPolicyTooLargeException extends StsException implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, PackedPolicyTooLargeException>, StsException.Builder {
        @Override
