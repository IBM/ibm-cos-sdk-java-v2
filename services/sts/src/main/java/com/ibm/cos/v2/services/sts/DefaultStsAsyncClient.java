...
import com.ibm.cos.v2.awscore.client.handler.AwsAsyncClientHandler;
...
import com.ibm.cos.v2.protocols.query.AwsQueryProtocolFactory;
...
import com.ibm.cos.v2.services.sts.model.AssumeRoleResponse;
...
import com.ibm.cos.v2.services.sts.model.AssumeRoleWithWebIdentityRequest;
import com.ibm.cos.v2.services.sts.model.AssumeRoleWithWebIdentityResponse;
import com.ibm.cos.v2.services.sts.model.AssumeRootRequest;
import com.ibm.cos.v2.services.sts.model.AssumeRootResponse;
import com.ibm.cos.v2.services.sts.model.DecodeAuthorizationMessageRequest;
import com.ibm.cos.v2.services.sts.model.DecodeAuthorizationMessageResponse;
import com.ibm.cos.v2.services.sts.model.ExpiredTokenException;
import com.ibm.cos.v2.services.sts.model.GetAccessKeyInfoRequest;
import com.ibm.cos.v2.services.sts.model.GetAccessKeyInfoResponse;
import com.ibm.cos.v2.services.sts.model.GetCallerIdentityRequest;
import com.ibm.cos.v2.services.sts.model.GetCallerIdentityResponse;
import com.ibm.cos.v2.services.sts.model.GetFederationTokenRequest;
import com.ibm.cos.v2.services.sts.model.GetFederationTokenResponse;
...
import com.ibm.cos.v2.services.sts.model.IdpCommunicationErrorException;
import com.ibm.cos.v2.services.sts.model.IdpRejectedClaimException;
import com.ibm.cos.v2.services.sts.model.InvalidAuthorizationMessageException;
import com.ibm.cos.v2.services.sts.model.InvalidIdentityTokenException;
import com.ibm.cos.v2.services.sts.model.MalformedPolicyDocumentException;
import com.ibm.cos.v2.services.sts.model.PackedPolicyTooLargeException;
import com.ibm.cos.v2.services.sts.model.RegionDisabledException;
import com.ibm.cos.v2.services.sts.model.StsException;
import com.ibm.cos.v2.services.sts.transform.AssumeRoleRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.AssumeRoleWithSamlRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.AssumeRoleWithWebIdentityRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.AssumeRootRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.DecodeAuthorizationMessageRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.GetAccessKeyInfoRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.GetCallerIdentityRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.GetFederationTokenRequestMarshaller;
import com.ibm.cos.v2.services.sts.transform.GetSessionTokenRequestMarshaller;
import com.ibm.cos.v2.utils.CompletableFutureUtils;

/**
 * Internal implementation of {@link StsAsyncClient}.
 *
 * @see StsAsyncClient#builder()
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
final class DefaultStsAsyncClient implements StsAsyncClient {
     ...
     * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_sts-comparison.html">Compare STS
     * credentials</a> in the <i>IAM User Guide</i>.
     * </p>
     * <p>
     * <b>Permissions</b>
     * </p>
     ...
     * (ARNs) to use as managed session policies. The plaintext that you use for both inline and managed session
     * policies can't exceed 2,048 characters. Passing policies to this operation returns new temporary credentials. The
     ...
     * resources in the account that owns the role. You cannot use session policies to grant more permissions than those
     ...
     * @return A Java Future containing the result of the AssumeRole operation returned by the service.<br/>
     ...
     *         <li>PackedPolicyTooLargeException The request was rejected because the total packed size of the session
     *         policies and session tags combined was too large. An Amazon Web Services conversion compresses the
     *         session policy document, session policy ARNs, and session tags into a packed binary format that has a
     *         separate limit. The error message indicates by percentage how close the policies and tags are to the
     *         upper size limit. For more information, see <a
     ...
     *         >IAM and STS Entity Character Limits</a> in the <i>IAM User Guide</i>.</li>
     *         <li>RegionDisabledException STS is not activated in the requested region for the account that is being
     *         asked to generate credentials. The account administrator must use the IAM console to activate STS in that
     *         region. For more information, see <a
     *         href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html"
     *         >Activating and Deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User Guide</i>.</li>
     *         <li>ExpiredTokenException The web identity token that was passed is expired or is not valid. Get a new
     *         identity token from the identity provider and then retry the request.</li>
     *         <li>SdkException Base class for all exceptions that can be thrown by the SDK (both service and client).
     *         Can be used for catch all scenarios.</li>
     *         <li>SdkClientException If any client side error occurs such as an IO related failure, failure to get
     *         credentials, etc.</li>
     *         <li>StsException Base class for all service exceptions. Unknown exceptions will be thrown as an instance
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.AssumeRole
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRole" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<AssumeRoleResponse> assumeRole(AssumeRoleRequest assumeRoleRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(assumeRoleRequest, this.clientConfiguration);
        ...
        try {
            ...
            CompletableFuture<AssumeRoleResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<AssumeRoleRequest, AssumeRoleResponse>().withOperationName("AssumeRole")
                            ...
                            .withInput(assumeRoleRequest));
            CompletableFuture<AssumeRoleResponse> whenCompleteFuture = null;
     ...
     * @return A Java Future containing the result of the AssumeRoleWithSAML operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-limits-entity-length"
     *         >IAM and STS Entity Character Limits</a> in the <i>IAM User Guide</i>.</li>
     *         <li>IdpRejectedClaimException The identity provider (IdP) reported that authentication failed. This might
     *         be because the claim is invalid.</p>
     *         <p>
     *         If this error is returned for the <code>AssumeRoleWithWebIdentity</code> operation, it can also mean that
     *         the claim has expired or has been explicitly revoked.</li>
     *         <li>InvalidIdentityTokenException The web identity token that was passed could not be validated by Amazon
     *         Web Services. Get a new identity token from the identity provider and then retry the request.</li>
     *         <li>ExpiredTokenException The web identity token that was passed is expired or is not valid. Get a new
     *         identity token from the identity provider and then retry the request.</li>
     *         <li>RegionDisabledException STS is not activated in the requested region for the account that is being
     *         asked to generate credentials. The account administrator must use the IAM console to activate STS in that
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.AssumeRoleWithSAML
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoleWithSAML" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<AssumeRoleWithSamlResponse> assumeRoleWithSAML(AssumeRoleWithSamlRequest assumeRoleWithSamlRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(assumeRoleWithSamlRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, assumeRoleWithSamlRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<AssumeRoleWithSamlResponse> responseHandler = protocolFactory
                    .createResponseHandler(AssumeRoleWithSamlResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<AssumeRoleWithSamlResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<AssumeRoleWithSamlRequest, AssumeRoleWithSamlResponse>()
                            .withOperationName("AssumeRoleWithSAML").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new AssumeRoleWithSamlRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(assumeRoleWithSamlRequest));
            CompletableFuture<AssumeRoleWithSamlResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     * >Update the maximum session duration for a role </a> in the <i>IAM User Guide</i>. The maximum session duration
     * limit applies when you use the <code>AssumeRole*</code> API operations or the <code>assume-role*</code> CLI
     * commands. However the limit does not apply when you use those operations to create a console URL. For more
     * information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use.html">Using IAM Roles</a>
     * in the <i>IAM User Guide</i>.
     ...
     * </important>
     * <p>
     * For more information about how to use OIDC federation and the <code>AssumeRoleWithWebIdentity</code> API, see the
     * following resources:
     * </p>
     * <ul>
     * <li>
     ...
     * @return A Java Future containing the result of the AssumeRoleWithWebIdentity operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         If this error is returned for the <code>AssumeRoleWithWebIdentity</code> operation, it can also mean that
     *         the claim has expired or has been explicitly revoked.</li>
     *         <li>IdpCommunicationErrorException The request could not be fulfilled because the identity provider (IDP)
     *         that was asked to verify the incoming identity token could not be reached. This is often a transient
     *         error caused by network conditions. Retry the request a limited number of times so that you don't exceed
     *         the request rate. If the error persists, the identity provider might be down or not responding.</li>
     *         <li>InvalidIdentityTokenException The web identity token that was passed could not be validated by Amazon
     *         Web Services. Get a new identity token from the identity provider and then retry the request.</li>
     *         <li>ExpiredTokenException The web identity token that was passed is expired or is not valid. Get a new
     *         identity token from the identity provider and then retry the request.</li>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.AssumeRoleWithWebIdentity
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoleWithWebIdentity" target="_top">AWS
     *      API Documentation</a>
     */
    @Override
    public CompletableFuture<AssumeRoleWithWebIdentityResponse> assumeRoleWithWebIdentity(
            AssumeRoleWithWebIdentityRequest assumeRoleWithWebIdentityRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(assumeRoleWithWebIdentityRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, assumeRoleWithWebIdentityRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<AssumeRoleWithWebIdentityResponse> responseHandler = protocolFactory
                    .createResponseHandler(AssumeRoleWithWebIdentityResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<AssumeRoleWithWebIdentityResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<AssumeRoleWithWebIdentityRequest, AssumeRoleWithWebIdentityResponse>()
                            .withOperationName("AssumeRoleWithWebIdentity").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new AssumeRoleWithWebIdentityRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(assumeRoleWithWebIdentityRequest));
            CompletableFuture<AssumeRoleWithWebIdentityResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
    ...
    /**
     * <p>
     * Returns a set of short term credentials you can use to perform privileged tasks on a member account in your
     * organization.
     * </p>
     * <p>
     * Before you can launch a privileged session, you must have centralized root access in your organization. For steps
     * to enable this feature, see <a
     * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-enable-root-access.html">Centralize root access
     * for member accounts</a> in the <i>IAM User Guide</i>.
     * </p>
     * <note>
     * <p>
     * The STS global endpoint is not supported for AssumeRoot. You must send this request to a Regional STS endpoint.
     * For more information, see <a
     * href="https://docs.aws.amazon.com/STS/latest/APIReference/welcome.html#sts-endpoints">Endpoints</a>.
     * </p>
     * </note>
     * <p>
     * You can track AssumeRoot in CloudTrail logs to determine what actions were performed in a session. For more
     * information, see <a
     * href="https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-track-privileged-tasks.html">Track privileged
     * tasks in CloudTrail</a> in the <i>IAM User Guide</i>.
     * </p>
     *
     * @param assumeRootRequest
     * @return A Java Future containing the result of the AssumeRoot operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.AssumeRoot
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/AssumeRoot" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<AssumeRootResponse> assumeRoot(AssumeRootRequest assumeRootRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(assumeRootRequest, this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, assumeRootRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<AssumeRootResponse> responseHandler = protocolFactory
                    .createResponseHandler(AssumeRootResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<AssumeRootResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<AssumeRootRequest, AssumeRootResponse>().withOperationName("AssumeRoot")
                            .withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new AssumeRootRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(assumeRootRequest));
            CompletableFuture<AssumeRootResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     * @return A Java Future containing the result of the DecodeAuthorizationMessage operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     *         <li>InvalidAuthorizationMessageException The error returned if the message passed to
     *         <code>DecodeAuthorizationMessage</code> was invalid. This can happen if the token contains invalid
     *         characters, such as line breaks, or if the message has expired.</li>
     *         <li>SdkException Base class for all exceptions that can be thrown by the SDK (both service and client).
     *         Can be used for catch all scenarios.</li>
     *         <li>SdkClientException If any client side error occurs such as an IO related failure, failure to get
     *         credentials, etc.</li>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.DecodeAuthorizationMessage
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/DecodeAuthorizationMessage"
     *      target="_top">AWS API Documentation</a>
     */
    @Override
    public CompletableFuture<DecodeAuthorizationMessageResponse> decodeAuthorizationMessage(
            DecodeAuthorizationMessageRequest decodeAuthorizationMessageRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(decodeAuthorizationMessageRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, decodeAuthorizationMessageRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<DecodeAuthorizationMessageResponse> responseHandler = protocolFactory
                    .createResponseHandler(DecodeAuthorizationMessageResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<DecodeAuthorizationMessageResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<DecodeAuthorizationMessageRequest, DecodeAuthorizationMessageResponse>()
                            .withOperationName("DecodeAuthorizationMessage").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new DecodeAuthorizationMessageRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(decodeAuthorizationMessageRequest));
            CompletableFuture<DecodeAuthorizationMessageResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     * @return A Java Future containing the result of the GetAccessKeyInfo operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.GetAccessKeyInfo
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetAccessKeyInfo" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<GetAccessKeyInfoResponse> getAccessKeyInfo(GetAccessKeyInfoRequest getAccessKeyInfoRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(getAccessKeyInfoRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, getAccessKeyInfoRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<GetAccessKeyInfoResponse> responseHandler = protocolFactory
                    .createResponseHandler(GetAccessKeyInfoResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<GetAccessKeyInfoResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<GetAccessKeyInfoRequest, GetAccessKeyInfoResponse>()
                            .withOperationName("GetAccessKeyInfo").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new GetAccessKeyInfoRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(getAccessKeyInfoRequest));
            CompletableFuture<GetAccessKeyInfoResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     * @return A Java Future containing the result of the GetCallerIdentity operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.GetCallerIdentity
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetCallerIdentity" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<GetCallerIdentityResponse> getCallerIdentity(GetCallerIdentityRequest getCallerIdentityRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(getCallerIdentityRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, getCallerIdentityRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<GetCallerIdentityResponse> responseHandler = protocolFactory
                    .createResponseHandler(GetCallerIdentityResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<GetCallerIdentityResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<GetCallerIdentityRequest, GetCallerIdentityResponse>()
                            .withOperationName("GetCallerIdentity").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new GetCallerIdentityRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(getCallerIdentityRequest));
            CompletableFuture<GetCallerIdentityResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.GetFederationToken
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetFederationToken" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<GetFederationTokenResponse> getFederationToken(GetFederationTokenRequest getFederationTokenRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(getFederationTokenRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, getFederationTokenRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<GetFederationTokenResponse> responseHandler = protocolFactory
                    .createResponseHandler(GetFederationTokenResponse::builder);
            ...
            CompletableFuture<GetFederationTokenResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<GetFederationTokenRequest, GetFederationTokenResponse>()
                            .withOperationName("GetFederationToken").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new GetFederationTokenRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(getFederationTokenRequest));
            CompletableFuture<GetFederationTokenResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
     ...
     * @return A Java Future containing the result of the GetSessionToken operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     *         {@link Throwable#getCause} to retrieve the underlying exception.
     *         <ul>
     ...
     *         of this type.</li>
     *         </ul>
     * @sample StsAsyncClient.GetSessionToken
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/sts-2011-06-15/GetSessionToken" target="_top">AWS API
     *      Documentation</a>
     */
    @Override
    public CompletableFuture<GetSessionTokenResponse> getSessionToken(GetSessionTokenRequest getSessionTokenRequest) {
        SdkClientConfiguration clientConfiguration = updateSdkClientConfiguration(getSessionTokenRequest,
                this.clientConfiguration);
        List<MetricPublisher> metricPublishers = resolveMetricPublishers(clientConfiguration, getSessionTokenRequest
                .overrideConfiguration().orElse(null));
        MetricCollector apiCallMetricCollector = metricPublishers.isEmpty() ? NoOpMetricCollector.create() : MetricCollector
                .create("ApiCall");
        try {
            ...
            HttpResponseHandler<GetSessionTokenResponse> responseHandler = protocolFactory
                    .createResponseHandler(GetSessionTokenResponse::builder);

            HttpResponseHandler<AwsServiceException> errorResponseHandler = protocolFactory.createErrorResponseHandler();

            CompletableFuture<GetSessionTokenResponse> executeFuture = clientHandler
                    .execute(new ClientExecutionParams<GetSessionTokenRequest, GetSessionTokenResponse>()
                            .withOperationName("GetSessionToken").withProtocolMetadata(protocolMetadata)
                            .withMarshaller(new GetSessionTokenRequestMarshaller(protocolFactory))
                            .withResponseHandler(responseHandler).withErrorResponseHandler(errorResponseHandler)
                            .withRequestConfiguration(clientConfiguration).withMetricCollector(apiCallMetricCollector)
                            .withInput(getSessionTokenRequest));
            CompletableFuture<GetSessionTokenResponse> whenCompleteFuture = null;
            whenCompleteFuture = executeFuture.whenComplete((r, e) -> {
                metricPublishers.forEach(p -> p.publish(apiCallMetricCollector.collect()));
            });
            return CompletableFutureUtils.forwardExceptionTo(whenCompleteFuture, executeFuture);
    ...
    private AwsQueryProtocolFactory init() {
        return AwsQueryProtocolFactory
                ...
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("InvalidAuthorizationMessageException")
                                .exceptionBuilderSupplier(InvalidAuthorizationMessageException::builder).httpStatusCode(400)
                                .build())
                .registerModeledException(
                ...
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("PackedPolicyTooLarge")
                                .exceptionBuilderSupplier(PackedPolicyTooLargeException::builder).httpStatusCode(400).build())
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("RegionDisabledException")
                                .exceptionBuilderSupplier(RegionDisabledException::builder).httpStatusCode(403).build())
                .registerModeledException(
                ...
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("IDPRejectedClaim")
                                .exceptionBuilderSupplier(IdpRejectedClaimException::builder).httpStatusCode(403).build())
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("InvalidIdentityToken")
                                .exceptionBuilderSupplier(InvalidIdentityTokenException::builder).httpStatusCode(400).build())
                .registerModeledException(
                        ExceptionMetadata.builder().errorCode("IDPCommunicationError")
                                .exceptionBuilderSupplier(IdpCommunicationErrorException::builder).httpStatusCode(400).build())
                .clientConfiguration(clientConfiguration).defaultServiceExceptionSupplier(StsException::builder).build();
    }
