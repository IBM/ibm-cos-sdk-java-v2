...
/**
 * {@link GetSessionTokenRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class GetSessionTokenRequestMarshaller implements Marshaller<GetSessionTokenRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .operationIdentifier("GetSessionToken").apiVersion("2011-06-15").build();
    ...
    public SdkHttpFullRequest marshall(GetSessionTokenRequest getSessionTokenRequest) {
        Validate.paramNotNull(getSessionTokenRequest, "getSessionTokenRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getSessionTokenRequest);
        } catch (Exception e) {
