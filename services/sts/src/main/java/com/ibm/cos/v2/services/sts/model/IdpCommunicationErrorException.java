...
public final class IdpCommunicationErrorException extends StsException implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, IdpCommunicationErrorException>, StsException.Builder {
        @Override
