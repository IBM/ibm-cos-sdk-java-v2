...
public final class RegionDisabledException extends StsException implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, RegionDisabledException>, StsException.Builder {
        @Override
