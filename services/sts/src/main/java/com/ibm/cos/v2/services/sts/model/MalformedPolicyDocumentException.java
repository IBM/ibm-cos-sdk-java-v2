...
public final class MalformedPolicyDocumentException extends StsException implements
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, MalformedPolicyDocumentException>, StsException.Builder {
        @Override
