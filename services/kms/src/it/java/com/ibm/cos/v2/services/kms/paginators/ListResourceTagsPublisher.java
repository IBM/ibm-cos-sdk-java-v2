 ...
 * {@link com.ibm.cos.v2.services.kms.KmsAsyncClient#listResourceTagsPaginator(com.ibm.cos.v2.services.kms.model.ListResourceTagsRequest)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link com.ibm.cos.v2.services.kms.model.ListResourceTagsResponse} response
 ...
 * <pre>
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListResourceTagsPublisher publisher = client.listResourceTagsPaginator(request);
 ...
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListResourceTagsPublisher publisher = client.listResourceTagsPaginator(request);
 * publisher.subscribe(new Subscriber<com.ibm.cos.v2.services.kms.model.ListResourceTagsResponse>() {
 * 
 * public void onSubscribe(org.reactivestreams.Subscriber subscription) { //... };
 * 
 * 
 * public void onNext(com.ibm.cos.v2.services.kms.model.ListResourceTagsResponse response) { //... };
 * });}
 * </pre>
 * 
