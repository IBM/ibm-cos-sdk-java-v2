...
import com.ibm.cos.v2.services.kms.model.DeriveSharedSecretRequest;
import com.ibm.cos.v2.utils.Validate;

/**
 * {@link DeriveSharedSecretRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class DeriveSharedSecretRequestMarshaller implements Marshaller<DeriveSharedSecretRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .hasPayloadMembers(true).operationIdentifier("TrentService.DeriveSharedSecret").build();

    private final BaseAwsJsonProtocolFactory protocolFactory;

    public DeriveSharedSecretRequestMarshaller(BaseAwsJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(DeriveSharedSecretRequest deriveSharedSecretRequest) {
        Validate.paramNotNull(deriveSharedSecretRequest, "deriveSharedSecretRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(deriveSharedSecretRequest);
        } catch (Exception e) {
