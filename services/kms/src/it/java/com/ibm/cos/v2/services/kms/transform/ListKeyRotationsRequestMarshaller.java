...
/**
 * {@link ListKeyRotationsRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class ListKeyRotationsRequestMarshaller implements Marshaller<ListKeyRotationsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .hasPayloadMembers(true).operationIdentifier("TrentService.ListKeyRotations").build();
    ...
    public SdkHttpFullRequest marshall(ListKeyRotationsRequest listKeyRotationsRequest) {
        Validate.paramNotNull(listKeyRotationsRequest, "listKeyRotationsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listKeyRotationsRequest);
        } catch (Exception e) {
