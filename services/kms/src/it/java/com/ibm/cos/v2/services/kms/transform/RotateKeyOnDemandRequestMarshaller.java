...
import com.ibm.cos.v2.services.kms.model.RotateKeyOnDemandRequest;
import com.ibm.cos.v2.utils.Validate;

/**
 * {@link RotateKeyOnDemandRequest} Marshaller
 */
@Generated("com.ibm.cos.v2:codegen")
@SdkInternalApi
public class RotateKeyOnDemandRequestMarshaller implements Marshaller<RotateKeyOnDemandRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .hasPayloadMembers(true).operationIdentifier("TrentService.RotateKeyOnDemand").build();

    private final BaseAwsJsonProtocolFactory protocolFactory;

    public RotateKeyOnDemandRequestMarshaller(BaseAwsJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    @Override
    public SdkHttpFullRequest marshall(RotateKeyOnDemandRequest rotateKeyOnDemandRequest) {
        Validate.paramNotNull(rotateKeyOnDemandRequest, "rotateKeyOnDemandRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(rotateKeyOnDemandRequest);
        } catch (Exception e) {
