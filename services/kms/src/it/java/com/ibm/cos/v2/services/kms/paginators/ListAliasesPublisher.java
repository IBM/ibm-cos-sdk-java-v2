 ...
 * {@link com.ibm.cos.v2.services.kms.KmsAsyncClient#listAliasesPaginator(com.ibm.cos.v2.services.kms.model.ListAliasesRequest)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link com.ibm.cos.v2.services.kms.model.ListAliasesResponse} response pages as
 ...
 * <pre>
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListAliasesPublisher publisher = client.listAliasesPaginator(request);
 ...
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListAliasesPublisher publisher = client.listAliasesPaginator(request);
 * publisher.subscribe(new Subscriber<com.ibm.cos.v2.services.kms.model.ListAliasesResponse>() {
 * 
 * public void onSubscribe(org.reactivestreams.Subscriber subscription) { //... };
 * 
 * 
 * public void onNext(com.ibm.cos.v2.services.kms.model.ListAliasesResponse response) { //... };
 * });}
 * </pre>
 * 
