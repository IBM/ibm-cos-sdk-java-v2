...
public class Outputs {
    ...
    public boolean equals(Object o) {
        ...
        if ((dnsSuffix != null && !dnsSuffix.equals(outputs.dnsSuffix)) || (dnsSuffix == null && outputs.dnsSuffix != null)) {
            return false;
        }
    ...
    public String toString() {
        return ToString.builder("Outputs").add("dnsSuffix", dnsSuffix).add("dualStackDnsSuffix", dualStackDnsSuffix)
                .add("supportsFips", supportsFips).add("supportsDualStack", supportsDualStack)
                .add("implicitGlobalRegion", implicitGlobalRegion).build();
    }
