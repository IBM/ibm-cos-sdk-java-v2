 ...
 * {@link com.ibm.cos.v2.services.kms.KmsAsyncClient#listRetirableGrantsPaginator(com.ibm.cos.v2.services.kms.model.ListRetirableGrantsRequest)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link com.ibm.cos.v2.services.kms.model.ListRetirableGrantsResponse} response
 ...
 * <pre>
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListRetirableGrantsPublisher publisher = client.listRetirableGrantsPaginator(request);
 ...
 * {@code
 * com.ibm.cos.v2.services.kms.paginators.ListRetirableGrantsPublisher publisher = client.listRetirableGrantsPaginator(request);
 * publisher.subscribe(new Subscriber<com.ibm.cos.v2.services.kms.model.ListRetirableGrantsResponse>() {
 * 
 * public void onSubscribe(org.reactivestreams.Subscriber subscription) { //... };
 * 
 * 
 * public void onNext(com.ibm.cos.v2.services.kms.model.ListRetirableGrantsResponse response) { //... };
 * });}
 * </pre>
 * 
