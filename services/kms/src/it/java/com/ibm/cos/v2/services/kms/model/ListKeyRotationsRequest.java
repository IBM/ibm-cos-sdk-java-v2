...
public final class ListKeyRotationsRequest extends KmsRequest implements
        ToCopyableBuilder<ListKeyRotationsRequest.Builder, ListKeyRotationsRequest> {
    private static final SdkField<String> KEY_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("KeyId")
            .getter(getter(ListKeyRotationsRequest::keyId)).setter(setter(Builder::keyId))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("KeyId").build()).build();

    private static final SdkField<Integer> LIMIT_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER).memberName("Limit")
            .getter(getter(ListKeyRotationsRequest::limit)).setter(setter(Builder::limit))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Limit").build()).build();

    private static final SdkField<String> MARKER_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("Marker")
            .getter(getter(ListKeyRotationsRequest::marker)).setter(setter(Builder::marker))
    ...
    private ListKeyRotationsRequest(BuilderImpl builder) {
        super(builder);
     ...
     * </p>
     * 
     * @return Gets the key rotations for the specified KMS key.</p>
     *         <p>
     *         Specify the key ID or key ARN of the KMS key.
     *         </p>
     *         <p>
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof ListKeyRotationsRequest)) {
            return false;
        }
    ...
    public final String toString() {
        return ToString.builder("ListKeyRotationsRequest").add("KeyId", keyId()).add("Limit", limit()).add("Marker", marker())
                .build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<ListKeyRotationsRequest, T> g) {
        return obj -> g.apply((ListKeyRotationsRequest) obj);
    }
    ...
    @Mutable
    @NotThreadSafe
    public interface Builder extends KmsRequest.Builder, SdkPojo, CopyableBuilder<Builder, ListKeyRotationsRequest> {
        /**
         * <p>
         * Gets the key rotations for the specified KMS key.
         * </p>
         ...
         * 
         * @param keyId
         *        Gets the key rotations for the specified KMS key.</p>
         *        <p>
         *        Specify the key ID or key ARN of the KMS key.
         *        </p>
         *        <p>
    ...
    static final class BuilderImpl extends KmsRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(ListKeyRotationsRequest model) {
            super(model);
            keyId(model.keyId);
            limit(model.limit);
            marker(model.marker);
        ...
        @Override
        public ListKeyRotationsRequest build() {
            return new ListKeyRotationsRequest(this);
        }
