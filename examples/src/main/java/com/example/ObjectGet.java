...
public class ObjectGet {
    public static void main(String[] args) {
        ...
        String destinationObjectPath = "/path/to/object";
        getObject(client, bucketName, objectKey, destinationObjectPath);
     ...
     * @param objectPath the local file path of the object to be downloaded
     */
    public static void getObject(S3Client client, String bucketName, String objectKey, String objectPath) {
        GetObjectRequest getObjectRequest = GetObjectRequest.builder()
                .bucket(bucketName)
                .key(objectKey)
                .build();
        client.getObject(getObjectRequest, ResponseTransformer.toFile(new File(objectPath)));

        System.out.println("Get object " + objectKey + " from bucket " + bucketName + " and save as " + objectPath);
    }
}
