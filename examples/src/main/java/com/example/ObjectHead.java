...
public class ObjectHead {
    public static void main(String[] args) {
        ...
        getContentType(client, bucketName, objectKey);
    ...
    /**
     * Retrieves the content type of object stored in COS bucket.
     *
     ...
     */
    public static void getContentType(S3Client client, String bucketName, String objectKey) {
