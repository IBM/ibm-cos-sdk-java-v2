...
public class ObjectMetadata {
    public static void main(String[] args) {
        ...
        putObjectWithMetadata(client, bucketName, objectKey, objectPath);
    ...
    /**
     * Put an object with user defined metadata.
     *
     ...
     */
    private static void putObjectWithMetadata(S3Client client, String bucketName, String objectKey, String objectPath) {
        ...
        System.out.println("Put object " + objectPath + " into bucket " + bucketName);
    }
}
