...
package com.ibm.cos.v2.http.urlconnection;

import static com.ibm.cos.v2.http.Header.ACCEPT;
import static com.ibm.cos.v2.http.Header.CONTENT_LENGTH;
import static com.ibm.cos.v2.http.HttpStatusFamily.CLIENT_ERROR;
import static com.ibm.cos.v2.http.HttpStatusFamily.SERVER_ERROR;
 ...
 *
 * <p>See com.ibm.cos.v2.http.apache.ApacheHttpClient for an alternative implementation.</p>
 *
...
public final class UrlConnectionHttpClient implements SdkHttpClient {
    ...
    private HttpURLConnection createAndConfigureConnection(HttpExecuteRequest request) {
        ...
        // See: https://github.com/aws/ibm-cos-java-sdk-v2/issues/975
