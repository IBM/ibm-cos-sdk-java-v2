...
import com.ibm.cos.v2.http.nio.netty.internal.http2.Http2MultiplexedChannelPool;
...
public class ReleaseOnceChannelPool implements SdkChannelPool {
    ...
    private static final AttributeKey<AtomicBoolean> IS_RELEASED = NettyUtils.getOrCreateAttributeKey(
            "com.ibm.cos.v2.http.nio.netty.internal.http2.ReleaseOnceChannelPool.isReleased");
