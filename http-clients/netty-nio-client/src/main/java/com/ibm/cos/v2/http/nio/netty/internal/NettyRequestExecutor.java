...
import static com.ibm.cos.v2.http.HttpMetric.CONCURRENCY_ACQUIRE_DURATION;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.CHANNEL_DIAGNOSTICS;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.EXECUTE_FUTURE_KEY;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.EXECUTION_ID_KEY;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.IN_USE;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.KEEP_ALIVE;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.REQUEST_CONTEXT_KEY;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.RESPONSE_COMPLETE_KEY;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.RESPONSE_CONTENT_LENGTH;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.RESPONSE_DATA_READ;
import static com.ibm.cos.v2.http.nio.netty.internal.ChannelAttributeKey.STREAMING_COMPLETE_KEY;
import static com.ibm.cos.v2.http.nio.netty.internal.NettyRequestMetrics.measureTimeTaken;
...
import com.ibm.cos.v2.http.nio.netty.internal.http2.FlushOnReadHandler;
import com.ibm.cos.v2.http.nio.netty.internal.http2.Http2StreamExceptionHandler;
import com.ibm.cos.v2.http.nio.netty.internal.http2.Http2ToHttpInboundAdapter;
import com.ibm.cos.v2.http.nio.netty.internal.http2.HttpToHttp2OutboundAdapter;
import com.ibm.cos.v2.http.nio.netty.internal.nrs.HttpStreamsClientHandler;
import com.ibm.cos.v2.http.nio.netty.internal.nrs.StreamedHttpRequest;
import com.ibm.cos.v2.http.nio.netty.internal.utils.ChannelUtils;
import com.ibm.cos.v2.http.nio.netty.internal.utils.NettyClientLogger;
import com.ibm.cos.v2.http.nio.netty.internal.utils.NettyUtils;
...
public final class NettyRequestExecutor {
     ...
     * com.ibm.cos.v2.http.async.SdkHttpContentPublisher}) to a publisher of {@link HttpContent}.
     * <p>
