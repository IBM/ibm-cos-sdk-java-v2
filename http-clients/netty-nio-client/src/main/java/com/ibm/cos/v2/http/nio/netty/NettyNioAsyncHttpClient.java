...
package com.ibm.cos.v2.http.nio.netty;

import static com.ibm.cos.v2.http.HttpMetric.HTTP_CLIENT_NAME;
import static com.ibm.cos.v2.http.nio.netty.internal.NettyConfiguration.EVENTLOOP_SHUTDOWN_FUTURE_TIMEOUT_SECONDS;
import static com.ibm.cos.v2.http.nio.netty.internal.NettyConfiguration.EVENTLOOP_SHUTDOWN_QUIET_PERIOD_SECONDS;
import static com.ibm.cos.v2.http.nio.netty.internal.NettyConfiguration.EVENTLOOP_SHUTDOWN_TIMEOUT_SECONDS;
import static com.ibm.cos.v2.http.nio.netty.internal.utils.NettyUtils.isAlpnSupported;
import static com.ibm.cos.v2.http.nio.netty.internal.utils.NettyUtils.runAndLogError;
import static com.ibm.cos.v2.http.nio.netty.internal.utils.NettyUtils.validateAlpnSupported;
...
import com.ibm.cos.v2.http.nio.netty.internal.AwaitCloseChannelPoolMap;
import com.ibm.cos.v2.http.nio.netty.internal.NettyConfiguration;
import com.ibm.cos.v2.http.nio.netty.internal.NettyRequestExecutor;
import com.ibm.cos.v2.http.nio.netty.internal.NonManagedEventLoopGroup;
import com.ibm.cos.v2.http.nio.netty.internal.RequestContext;
import com.ibm.cos.v2.http.nio.netty.internal.SdkChannelOptions;
import com.ibm.cos.v2.http.nio.netty.internal.SdkChannelPool;
import com.ibm.cos.v2.http.nio.netty.internal.SdkChannelPoolMap;
import com.ibm.cos.v2.http.nio.netty.internal.SharedSdkEventLoopGroup;
