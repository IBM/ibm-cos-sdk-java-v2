...
import static com.ibm.cos.v2.http.HttpMetric.AVAILABLE_CONCURRENCY;
import static com.ibm.cos.v2.http.HttpMetric.HTTP_CLIENT_NAME;
import static com.ibm.cos.v2.http.HttpMetric.LEASED_CONCURRENCY;
import static com.ibm.cos.v2.http.HttpMetric.MAX_CONCURRENCY;
import static com.ibm.cos.v2.http.HttpMetric.PENDING_CONCURRENCY_ACQUIRES;
import static com.ibm.cos.v2.http.apache.internal.conn.ClientConnectionRequestFactory.THREAD_LOCAL_REQUEST_METRIC_COLLECTOR;
import static com.ibm.cos.v2.utils.NumericUtils.saturatedCast;
...
import com.ibm.cos.v2.http.SystemPropertyTlsKeyManagersProvider;
import com.ibm.cos.v2.http.TlsKeyManagersProvider;
import com.ibm.cos.v2.http.TlsTrustManagersProvider;
import com.ibm.cos.v2.http.apache.internal.ApacheHttpRequestConfig;
import com.ibm.cos.v2.http.apache.internal.DefaultConfiguration;
import com.ibm.cos.v2.http.apache.internal.SdkProxyRoutePlanner;
import com.ibm.cos.v2.http.apache.internal.conn.ClientConnectionManagerFactory;
import com.ibm.cos.v2.http.apache.internal.conn.IdleConnectionReaper;
import com.ibm.cos.v2.http.apache.internal.conn.SdkConnectionKeepAliveStrategy;
import com.ibm.cos.v2.http.apache.internal.conn.SdkTlsSocketFactory;
import com.ibm.cos.v2.http.apache.internal.impl.ApacheHttpRequestFactory;
import com.ibm.cos.v2.http.apache.internal.impl.ApacheSdkHttpClient;
import com.ibm.cos.v2.http.apache.internal.impl.ConnectionManagerAwareHttpClient;
import com.ibm.cos.v2.http.apache.internal.utils.ApacheUtils;
 ...
 *
 * <p>See com.ibm.cos.v2.http.urlconnection.UrlConnectionHttpClient for an alternative implementation.</p>
 *
...
public final class ApacheHttpClient implements SdkHttpClient {
    ...
    private ConnectionManagerAwareHttpClient createClient(ApacheHttpClient.DefaultBuilder configuration,
        ...
        // from the reaper. See https://github.com/aws/ibm-cos-java-sdk/issues/722.
    ...
    public interface Builder extends SdkHttpClient.Builder<ApacheHttpClient.Builder> {
         ...
         * {@link com.ibm.cos.v2.internal.http.NoneTlsKeyManagersProvider} or another implementation of
