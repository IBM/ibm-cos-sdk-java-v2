...
package com.ibm.cos.v2.http.apache.internal.utils;
...
import com.ibm.cos.v2.http.apache.ProxyConfiguration;
import com.ibm.cos.v2.utils.Logger;
import com.ibm.cos.v2.utils.ReflectionMethodInvoker;
...
public final class ApacheUtils {
     ...
     * </p>
     *
     * For more information, See https://github.com/aws/ibm-cos-java-sdk/issues/1919
     */
    ...
    private static void noSuchMethodThrownByNormalizeUriInvoker() {
        ...
        logger.warn(() -> "NoSuchMethodException was thrown when disabling normalizeUri. This indicates you are using "
                 ...
                 + "the latency in exception handling. See https://github.com/aws/ibm-cos-java-sdk/issues/1919"
