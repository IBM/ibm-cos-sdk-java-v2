...
package com.ibm.cos.v2.thirdparty.org.slf4j.impl.internal;
...
public class LoggerAdapterTest {
    ...
    private static class TestCaseLogSFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSFn> logFn;
        private final Function<Logger, LogSFn> verify;

        private TestCaseLogSFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSFn> logFn,
    ...
    private static class TestCaseLogSTFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSTFn> logFn;
        private final Function<Logger, LogSTFn> verify;

        private TestCaseLogSTFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSTFn> logFn,
    ...
    private static class TestCaseLogMSFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSFn> logFn;
        private final Function<Logger, LogMSFn> verify;

        private TestCaseLogMSFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSFn> logFn,
    ...
    private static class TestCaseLogMSTFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSTFn> logFn;
        private final Function<Logger, LogMSTFn> verify;

        private TestCaseLogMSTFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSTFn> logFn,
    ...
    private static class TestCaseLogSOFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOFn> logFn;
        private final Function<Logger, LogSOFn> verify;

        private TestCaseLogSOFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOFn> logFn,
    ...
    private static class TestCaseLogMSOFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOFn> logFn;
        private final Function<Logger, LogMSOFn> verify;

        private TestCaseLogMSOFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOFn> logFn,
    ...
    private static class TestCaseLogSOOFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOOFn> logFn;
        private final Function<Logger, LogSOOFn> verify;

        private TestCaseLogSOOFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOOFn> logFn,
    ...
    private static class TestCaseLogMSOOFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOOFn> logFn;
        private final Function<Logger, LogMSOOFn> verify;

        private TestCaseLogMSOOFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOOFn> logFn,
    ...
    private static class TestCaseLogSOVarFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOVarFn> logFn;
        private final Function<Logger, LogSOVarFn> verify;

        private TestCaseLogSOVarFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogSOVarFn> logFn,
    ...
    private static class TestCaseLogMSOVarFn {
        private final Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOVarFn> logFn;
        private final Function<Logger, LogMSOVarFn> verify;

        private TestCaseLogMSOVarFn(Function<com.ibm.cos.v2.thirdparty.org.slf4j.Logger, LogShadedMSOVarFn> logFn,
    ...
    private interface LogShadedMSFn {
        void invoke(com.ibm.cos.v2.thirdparty.org.slf4j.Marker marker, String msg);
    }
    ...
    private interface LogShadedMSTFn {
        void invoke(com.ibm.cos.v2.thirdparty.org.slf4j.Marker marker, String msg, Throwable t);
    }
    ...
    private interface LogShadedMSOFn {
        void invoke(com.ibm.cos.v2.thirdparty.org.slf4j.Marker marker, String msg, Object o);
    }
    ...
    private interface LogShadedMSOOFn {
        void invoke(com.ibm.cos.v2.thirdparty.org.slf4j.Marker marker, String msg, Object o1, Object o2);
    }
