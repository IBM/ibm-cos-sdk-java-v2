...
public class ShadedMarkerAdapterTest {
    private Marker mockMarker;
    private ShadedMarkerAdapter markerAdapter;

    @BeforeEach
    public void setup() {
        mockMarker = mock(Marker.class);
        markerAdapter = new ShadedMarkerAdapter(mockMarker);
    }
    ...
    public void add_delegatesCall() {
        ...
        ShadedMarkerAdapter referenceAdapter = new ShadedMarkerAdapter(reference);
    ...
    public void iterator_adaptsReferences() {
        ...
        Iterator<com.ibm.cos.v2.thirdparty.org.slf4j.Marker> iterator = markerAdapter.iterator();
    ...
    public void equals_comparesNames() {
        ...
        ShadedMarkerAdapter m2Adapter = new ShadedMarkerAdapter(m2);
    ...
    public void hashCode_delegatesCall() {
        ShadedMarkerAdapter adapter = new ShadedMarkerAdapter(new TestMarker());
