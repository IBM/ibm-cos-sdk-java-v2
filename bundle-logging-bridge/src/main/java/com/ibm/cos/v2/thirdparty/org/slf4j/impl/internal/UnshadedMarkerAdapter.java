...
/**
 * Adapts a shaded {@link com.ibm.cos.v2.thirdparty.org.slf4j.Marker} to the unshaded {@link Marker}.
 */
@SdkInternalApi
public class UnshadedMarkerAdapter implements Marker {
    private static final long serialVersionUID = -2627393415659340178L;

    private final com.ibm.cos.v2.thirdparty.org.slf4j.Marker shaded;

    public UnshadedMarkerAdapter(com.ibm.cos.v2.thirdparty.org.slf4j.Marker shaded) {
        this.shaded = shaded;
    }

    public com.ibm.cos.v2.thirdparty.org.slf4j.Marker getShaded() {
        return shaded;
    }
    ...
    private static class IteratorAdapter implements Iterator<Marker> {
        private final Iterator<com.ibm.cos.v2.thirdparty.org.slf4j.Marker> shaded;

        IteratorAdapter(Iterator<com.ibm.cos.v2.thirdparty.org.slf4j.Marker> shaded) {
            this.shaded = shaded;
        }
