...
package com.ibm.cos.v2.http.auth.spi.signer;

import java.time.Clock;
import java.util.concurrent.CompletableFuture;
import java.util.function.Consumer;
import com.ibm.cos.v2.annotations.SdkPublicApi;
import com.ibm.cos.v2.http.auth.spi.internal.signer.DefaultAsyncSignRequest;
import com.ibm.cos.v2.http.auth.spi.internal.signer.DefaultSignRequest;
import com.ibm.cos.v2.http.auth.spi.internal.signer.NoOpHttpSigner;
