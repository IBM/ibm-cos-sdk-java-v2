...
public final class S3ServiceMetadata implements ServiceMetadata {
    ...
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(Region.of("af-south-1"),
            ...
            Region.of("aws-global"), Region.of("ca-central-1"), Region.of("ca-west-1"), Region.of("eu-central-1"),
            ...
            Region.of("fips-us-iso-east-1"), Region.of("us-iso-east-1"), Region.of("us-iso-west-1"), Region.of("us-isob-east-1"),
            Region.of("eu-isoe-west-1"), Region.of("us-isof-east-1"), Region.of("us-isof-south-1")));
    ...
    private static final List<ServicePartitionMetadata> PARTITIONS = Collections.unmodifiableList(Arrays.asList(
            ...
            new DefaultServicePartitionMetadata("aws-iso-f", null)));
    ...
    private static final Map<ServiceEndpointKey, String> SIGNING_REGIONS_BY_REGION = ImmutableMap
            ...
            .put(ServiceEndpointKey.builder().region(Region.of("fips-us-iso-east-1")).build(), "us-iso-east-1")
