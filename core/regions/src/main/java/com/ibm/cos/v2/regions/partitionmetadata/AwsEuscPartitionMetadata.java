...
@SdkPublicApi
public final class AwsEuscPartitionMetadata implements PartitionMetadata {
    private static final Map<PartitionEndpointKey, String> DNS_SUFFIXES = ImmutableMap.<PartitionEndpointKey, String> builder()
            .put(PartitionEndpointKey.builder().build(), "amazonaws.eu")
            .put(PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build(), "amazonaws.eu").build();
    ...
    private static final String ID = "aws-eusc";

    private static final String NAME = "AWS EUSC";

    private static final String REGION_REGEX = "^eusc\\-(de)\\-\\w+\\-\\d+$";
