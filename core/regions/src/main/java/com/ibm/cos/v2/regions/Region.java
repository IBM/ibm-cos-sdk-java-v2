...
public final class Region {
    public static final Region US_SOUTH = Region.of("us-south");
    ...
    private static final List<Region> REGIONS = Collections.unmodifiableList(Arrays.asList(AP_SOUTH_2, AP_SOUTH_1, EU_SOUTH_1,
            EU_SOUTH_2, US_GOV_EAST_1, ME_CENTRAL_1, IL_CENTRAL_1, US_ISOF_SOUTH_1, CA_CENTRAL_1, MX_CENTRAL_1, EU_CENTRAL_1,
            US_ISO_WEST_1, EUSC_DE_EAST_1, EU_CENTRAL_2, EU_ISOE_WEST_1, US_WEST_1, US_WEST_2, AF_SOUTH_1, EU_NORTH_1, EU_WEST_3,
            EU_WEST_2, EU_WEST_1, AP_NORTHEAST_3, AP_NORTHEAST_2, AP_NORTHEAST_1, ME_SOUTH_1, SA_EAST_1, AP_EAST_1, CN_NORTH_1,
            CA_WEST_1, US_GOV_WEST_1, AP_SOUTHEAST_1, AP_SOUTHEAST_2, US_ISO_EAST_1, AP_SOUTHEAST_3, AP_SOUTHEAST_4,
            AP_SOUTHEAST_5, US_EAST_1, US_EAST_2, AP_SOUTHEAST_7, CN_NORTHWEST_1, US_ISOB_EAST_1, US_ISOF_EAST_1, AWS_GLOBAL,
