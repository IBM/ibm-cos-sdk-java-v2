...
public final class AwsIsoFPartitionMetadata implements PartitionMetadata {
    private static final Map<PartitionEndpointKey, String> DNS_SUFFIXES = ImmutableMap.<PartitionEndpointKey, String> builder()
            .put(PartitionEndpointKey.builder().build(), "csp.hci.ic.gov")
            .put(PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build(), "csp.hci.ic.gov").build();
