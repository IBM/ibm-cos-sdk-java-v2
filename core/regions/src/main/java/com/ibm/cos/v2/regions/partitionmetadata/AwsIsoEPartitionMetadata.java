...
@SdkPublicApi
public final class AwsIsoEPartitionMetadata implements PartitionMetadata {
    private static final Map<PartitionEndpointKey, String> DNS_SUFFIXES = ImmutableMap.<PartitionEndpointKey, String> builder()
            .put(PartitionEndpointKey.builder().build(), "cloud.adc-e.uk")
            .put(PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build(), "cloud.adc-e.uk").build();
