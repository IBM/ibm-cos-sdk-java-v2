...
@SdkPublicApi
public final class AwsIsoPartitionMetadata implements PartitionMetadata {
    private static final Map<PartitionEndpointKey, String> DNS_SUFFIXES = ImmutableMap.<PartitionEndpointKey, String> builder()
            .put(PartitionEndpointKey.builder().build(), "c2s.ic.gov")
            .put(PartitionEndpointKey.builder().tags(EndpointTag.of("fips")).build(), "c2s.ic.gov").build();
