...
package com.ibm.cos.v2.awscore;

import static com.ibm.cos.v2.awscore.util.AwsHeader.AWS_REQUEST_ID;
import static com.ibm.cos.v2.awscore.util.AwsHeader.IBM_PROTECTION_MANAGEMENT_STATE;
...
public abstract class AwsResponseMetadata {
     ...
     *
     * @return The IBM Protection Management contained in this response metadata object.
     */
    public String ibmProtectionManagementState() {
        return getValue(IBM_PROTECTION_MANAGEMENT_STATE);
    }
