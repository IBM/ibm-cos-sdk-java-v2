...
import com.ibm.cos.v2.core.internal.http.pipeline.RequestPipelineBuilder;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.AfterExecutionInterceptorsStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.AfterTransmissionExecutionInterceptorsStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApiCallAttemptMetricCollectionStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApiCallAttemptTimeoutTrackingStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApiCallMetricCollectionStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApiCallTimeoutTrackingStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApplyTransactionIdStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ApplyUserAgentStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.BeforeTransmissionExecutionInterceptorsStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.BeforeUnmarshallingExecutionInterceptorsStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.CompressRequestStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.ExecutionFailureExceptionReportingStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.HandleResponseStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.HttpChecksumStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.MakeHttpRequestStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.MakeRequestImmutableStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.MakeRequestMutableStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.MergeCustomHeadersStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.MergeCustomQueryParamsStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.QueryParametersToBodyStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.RetryableStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.SigningStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.TimeoutExceptionHandlingStage;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.UnwrapResponseContainer;
