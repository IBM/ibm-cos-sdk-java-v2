 ...
 * checked for a file named '/com/ibm/cos/v2/global/handlers/execution.interceptors'. Any interceptors listed in these
 ...
 * classloader) are checked for a file named '/com/ibm/cos/v2/services/{service}/execution.interceptors', where
