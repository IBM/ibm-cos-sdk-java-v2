...
public enum SdkSystemSetting implements SystemSetting {
     ...
     */
    SYNC_HTTP_SERVICE_IMPL("com.ibm.cos.v2.http.service.impl", null),
     ...
     * since implementation discovery requires classpath scanning.
     */
    ASYNC_HTTP_SERVICE_IMPL("com.ibm.cos.v2.http.async.service.impl", null),
    ...
    IBM_API_KEY_ID("ibm.apiKeyId", null),

    /** Global System Property variable name for ibm service instance id */
    IBM_SERVICE_INSTANCE_ID("ibm.serviceInstanceId", null);
