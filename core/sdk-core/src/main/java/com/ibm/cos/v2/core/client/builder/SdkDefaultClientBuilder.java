...
package com.ibm.cos.v2.core.client.builder;

import static com.ibm.cos.v2.core.ClientType.ASYNC;
import static com.ibm.cos.v2.core.ClientType.SYNC;
import static com.ibm.cos.v2.core.client.config.SdkAdvancedAsyncClientOption.FUTURE_COMPLETION_EXECUTOR;
import static com.ibm.cos.v2.core.client.config.SdkAdvancedClientOption.USER_AGENT_PREFIX;
import static com.ibm.cos.v2.core.client.config.SdkAdvancedClientOption.USER_AGENT_SUFFIX;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.ADDITIONAL_HTTP_HEADERS;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.ASYNC_HTTP_CLIENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CLIENT_TYPE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CLIENT_USER_AGENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.COMPRESSION_CONFIGURATION;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_ASYNC_HTTP_CLIENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_ASYNC_HTTP_CLIENT_BUILDER;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_COMPRESSION_CONFIGURATION;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_RETRY_CONFIGURATOR;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_RETRY_MODE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_RETRY_STRATEGY;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_SCHEDULED_EXECUTOR_SERVICE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_SYNC_HTTP_CLIENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CONFIGURED_SYNC_HTTP_CLIENT_BUILDER;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.CRC32_FROM_COMPRESSED_DATA_ENABLED;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.DEFAULT_RETRY_MODE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.EXECUTION_INTERCEPTORS;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.HTTP_CLIENT_CONFIG;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.IDENTITY_PROVIDERS;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.INTERNAL_USER_AGENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.METRIC_PUBLISHERS;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.PROFILE_FILE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.PROFILE_FILE_SUPPLIER;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.PROFILE_NAME;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.RETRY_STRATEGY;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.SCHEDULED_EXECUTOR_SERVICE;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.SYNC_HTTP_CLIENT;
import static com.ibm.cos.v2.core.client.config.SdkClientOption.USER_AGENT_APP_ID;
import static com.ibm.cos.v2.core.internal.useragent.UserAgentConstant.APP_ID;
import static com.ibm.cos.v2.core.internal.useragent.UserAgentConstant.HTTP;
import static com.ibm.cos.v2.core.internal.useragent.UserAgentConstant.INTERNAL_METADATA_MARKER;
import static com.ibm.cos.v2.core.internal.useragent.UserAgentConstant.IO;
import static com.ibm.cos.v2.utils.CollectionUtils.mergeLists;
...
import com.ibm.cos.v2.annotations.SdkPreviewApi;
...
import com.ibm.cos.v2.core.ClientType;
import com.ibm.cos.v2.core.CompressionConfiguration;
import com.ibm.cos.v2.core.SdkPlugin;
import com.ibm.cos.v2.core.SdkSystemSetting;
import com.ibm.cos.v2.core.client.config.ClientAsyncConfiguration;
...
import com.ibm.cos.v2.core.internal.http.loader.DefaultSdkAsyncHttpClientBuilder;
import com.ibm.cos.v2.core.internal.http.loader.DefaultSdkHttpClientBuilder;
import com.ibm.cos.v2.core.internal.http.pipeline.stages.CompressRequestStage;
import com.ibm.cos.v2.core.internal.interceptor.HttpChecksumValidationInterceptor;
import com.ibm.cos.v2.core.internal.retry.SdkDefaultRetryStrategy;
import com.ibm.cos.v2.core.internal.useragent.AppIdResolver;
import com.ibm.cos.v2.core.internal.useragent.SdkClientUserAgentProperties;
import com.ibm.cos.v2.core.internal.useragent.SdkUserAgentBuilder;
...
import com.ibm.cos.v2.utils.AttributeMap.LazyValueSource;
import com.ibm.cos.v2.utils.Either;
...
public abstract class SdkDefaultClientBuilder<B extends SdkClientBuilder<B, C>, C> implements SdkClientBuilder<B, C> {
    ...
    /************************************ IBM Supported ********************************************************/
    @Override
    public final B iamEndpoint(String iamEndpoint) {
