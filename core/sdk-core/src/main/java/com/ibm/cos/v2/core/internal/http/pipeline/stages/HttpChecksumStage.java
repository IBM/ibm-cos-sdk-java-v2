...
import static com.ibm.cos.v2.core.HttpChecksumConstant.AWS_CHUNKED_HEADER;
import static com.ibm.cos.v2.core.HttpChecksumConstant.CONTENT_SHA_256_FOR_UNSIGNED_TRAILER;
import static com.ibm.cos.v2.core.HttpChecksumConstant.DEFAULT_ASYNC_CHUNK_SIZE;
import static com.ibm.cos.v2.core.HttpChecksumConstant.HEADER_FOR_TRAILER_REFERENCE;
import static com.ibm.cos.v2.core.HttpChecksumConstant.SIGNING_METHOD;
import static com.ibm.cos.v2.core.interceptor.SdkExecutionAttribute.RESOLVED_CHECKSUM_SPECS;
//import static com.ibm.cos.v2.core.interceptor.SdkInternalExecutionAttribute.AUTH_SCHEMES; TODO:REMOVE
import static com.ibm.cos.v2.core.interceptor.SdkInternalExecutionAttribute.AUTH_SCHEMES;
import static com.ibm.cos.v2.core.internal.io.AwsChunkedInputStream.DEFAULT_CHUNK_SIZE;
import static com.ibm.cos.v2.core.internal.util.ChunkContentUtils.calculateChecksumTrailerLength;
import static com.ibm.cos.v2.core.internal.util.ChunkContentUtils.calculateStreamContentLength;
import static com.ibm.cos.v2.core.internal.util.HttpChecksumResolver.getResolvedChecksumSpecs;
import static com.ibm.cos.v2.core.internal.util.HttpChecksumUtils.isHttpChecksumCalculationNeeded;
import static com.ibm.cos.v2.core.internal.util.HttpChecksumUtils.isStreamingUnsignedPayload;
...
import com.ibm.cos.v2.core.internal.async.ChecksumCalculatingAsyncRequestBody;
...
import com.ibm.cos.v2.core.internal.io.AwsUnsignedChunkedEncodingInputStream;
...
//import com.ibm.cos.v2.http.auth.aws.internal.signer.util.ChecksumUtil; TODO:REMOVE
import com.ibm.cos.v2.utils.BinaryUtils;
import com.ibm.cos.v2.utils.IoUtils;
import com.ibm.cos.v2.utils.Md5Utils;
...
public class HttpChecksumStage implements MutableRequestToRequestPipeline {
    ...
    private SdkHttpFullRequest.Builder sraChecksum(SdkHttpFullRequest.Builder request, RequestExecutionContext context) {
        ...
        //  and remove the logic here. Details in https://github.com/aws/ibm-cos-java-sdk-v2/pull/4568
    ...
    private static ChecksumSpecs checksumSpecsWithDefaultAlgorithm(ChecksumSpecs resolvedChecksumSpecs) {
        return (resolvedChecksumSpecs == null ? ChecksumSpecs.builder() : resolvedChecksumSpecs.toBuilder())
            ...
            //.headerName(ChecksumUtil.checksumHeaderName(DEFAULT_ALGORITHM)) TODO:REMOVE
            .build();
    }
    ...
    static final class ChecksumCalculatingStreamProvider implements ContentStreamProvider {
        ...
        private com.ibm.cos.v2.core.checksums.SdkChecksum sdkChecksum;
        ...
        ChecksumCalculatingStreamProvider(ContentStreamProvider underlyingInputStreamProvider,
            ...
            this.sdkChecksum = com.ibm.cos.v2.core.checksums.SdkChecksum.forAlgorithm(
        ...
        private void closeCurrentStream() {
            sdkChecksum = com.ibm.cos.v2.core.checksums.SdkChecksum.forAlgorithm(
                checksumSpecs.algorithm());
