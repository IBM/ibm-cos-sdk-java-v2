...
package com.ibm.cos.v2.core.internal.util;

import static com.ibm.cos.v2.checksums.DefaultChecksumAlgorithm.CRC32;
import static com.ibm.cos.v2.checksums.DefaultChecksumAlgorithm.CRC32C;
import static com.ibm.cos.v2.checksums.DefaultChecksumAlgorithm.CRC64NVME;
import static com.ibm.cos.v2.checksums.DefaultChecksumAlgorithm.SHA1;
import static com.ibm.cos.v2.checksums.DefaultChecksumAlgorithm.SHA256;
import static com.ibm.cos.v2.core.HttpChecksumConstant.HEADER_FOR_TRAILER_REFERENCE;
import static com.ibm.cos.v2.core.HttpChecksumConstant.HTTP_CHECKSUM_HEADER_PREFIX;
import static com.ibm.cos.v2.core.HttpChecksumConstant.SIGNING_METHOD;
import static com.ibm.cos.v2.core.HttpChecksumConstant.X_AMZ_TRAILER;
...
import com.ibm.cos.v2.core.internal.signer.SigningMethod;
...
public final class HttpChecksumUtils {
    ...
    private static Lazy<Boolean> isCrc64NvmeAvailable = new Lazy<>(() -> {
        try {
            ClassLoaderHelper.loadClass("com.ibm.cos.v2.crt.checksums.CRC64NVME", false);
