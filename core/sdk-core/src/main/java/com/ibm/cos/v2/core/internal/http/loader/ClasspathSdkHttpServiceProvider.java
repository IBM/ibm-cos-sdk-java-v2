...
package com.ibm.cos.v2.core.internal.http.loader;
...
import com.ibm.cos.v2.http.SdkHttpService;
import com.ibm.cos.v2.http.async.SdkAsyncHttpService;
...
final class ClasspathSdkHttpServiceProvider<T> implements SdkHttpServiceProvider<T> {
    ...
    static final Map<String, Integer> SYNC_HTTP_SERVICES_PRIORITY =
        ImmutableMap.<String, Integer>builder()
                    .put("com.ibm.cos.v2.http.apache.ApacheSdkHttpService", 1)
                    .put("com.ibm.cos.v2.http.urlconnection.UrlConnectionSdkHttpService", 2)
                    .put("com.ibm.cos.v2.http.crt.AwsCrtSdkHttpService", 3)
                    .build();

    static final Map<String, Integer> ASYNC_HTTP_SERVICES_PRIORITY =
        ImmutableMap.<String, Integer>builder()
                    .put("com.ibm.cos.v2.http.nio.netty.NettySdkAsyncHttpService", 1)
                    .put("com.ibm.cos.v2.http.crt.AwsCrtSdkHttpService", 2)
                    .build();
