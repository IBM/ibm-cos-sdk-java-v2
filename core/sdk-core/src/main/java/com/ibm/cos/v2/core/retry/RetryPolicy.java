...
package com.ibm.cos.v2.core.retry;
...
import com.ibm.cos.v2.core.internal.retry.SdkDefaultRetrySetting;
import com.ibm.cos.v2.core.retry.backoff.BackoffStrategy;
import com.ibm.cos.v2.core.retry.conditions.AndRetryCondition;
import com.ibm.cos.v2.core.retry.conditions.MaxNumberOfRetriesCondition;
import com.ibm.cos.v2.core.retry.conditions.RetryCondition;
import com.ibm.cos.v2.core.retry.conditions.TokenBucketRetryCondition;
 ...
 *
 * @deprecated Use instead {@link com.ibm.cos.v2.retries.api.RetryStrategy}.
 */
@Immutable
@SdkPublicApi
@Deprecated
public final class RetryPolicy implements ToCopyableBuilder<RetryPolicy.Builder, RetryPolicy> {
    ...
    RetryPolicy(BuilderImpl builder) {
