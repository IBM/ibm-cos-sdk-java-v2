...
import static com.ibm.cos.v2.core.http.HttpResponseHandler.X_AMZN_REQUEST_ID_HEADERS;
import static com.ibm.cos.v2.core.http.HttpResponseHandler.X_AMZ_ID_2_HEADER;
...
public final class SdkStandardLogger {
     ...
     */
    public static final Logger REQUEST_LOGGER = Logger.loggerFor("com.ibm.cos.v2.request");
     ...
     */
    public static final Logger REQUEST_ID_LOGGER = Logger.loggerFor("com.ibm.cos.v2.requestId");
