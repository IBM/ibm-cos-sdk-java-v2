package com.ibm.cos.v2.http.auth.aws;

import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.REGION_NAME;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.SERVICE_SIGNING_NAME;
import static com.ibm.cos.v2.http.auth.spi.signer.HttpSigner.SIGNING_CLOCK;
