...
import static com.ibm.cos.v2.http.auth.aws.TestUtils.generateBasicAsyncRequest;
import static com.ibm.cos.v2.http.auth.aws.TestUtils.generateBasicRequest;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.CONTENT_ENCODING;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.AUTH_LOCATION;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.CHECKSUM_ALGORITHM;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.CHUNK_ENCODING_ENABLED;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.EXPIRATION_DURATION;
import static com.ibm.cos.v2.http.auth.aws.signer.AwsV4HttpSigner.PAYLOAD_SIGNING_ENABLED;
...
import com.ibm.cos.v2.http.auth.aws.TestUtils;
import com.ibm.cos.v2.http.auth.aws.eventstream.internal.io.SigV4DataFramePublisher;
import com.ibm.cos.v2.http.auth.aws.signer.AwsV4FamilyHttpSigner.AuthLocation;
