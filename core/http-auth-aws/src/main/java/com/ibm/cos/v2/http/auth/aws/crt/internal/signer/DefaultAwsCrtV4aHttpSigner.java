...
import static com.ibm.cos.v2.http.auth.aws.crt.internal.util.CrtHttpRequestConverter.toRequest;
import static com.ibm.cos.v2.http.auth.aws.crt.internal.util.CrtUtils.sanitizeRequest;
import static com.ibm.cos.v2.http.auth.aws.crt.internal.util.CrtUtils.toCredentials;
...
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.CredentialUtils.isAnonymous;
...
import com.ibm.cos.v2.http.auth.aws.signer.AwsV4aHttpSigner;
