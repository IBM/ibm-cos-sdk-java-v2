...
package com.ibm.cos.v2.http.auth.aws.crt.internal.util;

import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.AUTHORIZATION;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.HOST;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_ALGORITHM;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_CREDENTIAL;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_DATE;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_EXPIRES;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_SIGNATURE;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_SIGNED_HEADERS;
