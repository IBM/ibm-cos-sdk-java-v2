...
import static com.ibm.cos.v2.http.auth.aws.internal.signer.V4CanonicalRequest.getCanonicalHeaders;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.V4CanonicalRequest.getSignedHeadersString;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.AWS4_SIGNING_ALGORITHM;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.X_AMZ_CONTENT_SHA256;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerUtils.addDateHeader;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerUtils.addHostHeader;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerUtils.formatDateTime;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerUtils.getContentHash;
