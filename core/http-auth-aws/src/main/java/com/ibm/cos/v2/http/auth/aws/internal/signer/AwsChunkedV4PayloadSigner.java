...
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.ChecksumUtil.checksumHeaderName;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.ChecksumUtil.fromChecksumAlgorithm;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.AWS_CHUNKED;
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerConstant.CONTENT_ENCODING;
...
import static com.ibm.cos.v2.http.auth.aws.internal.signer.util.SignerUtils.moveContentLength;
...
import com.ibm.cos.v2.http.auth.aws.internal.signer.chunkedencoding.ChecksumTrailerProvider;
import com.ibm.cos.v2.http.auth.aws.internal.signer.chunkedencoding.ChunkedEncodedInputStream;
import com.ibm.cos.v2.http.auth.aws.internal.signer.chunkedencoding.SigV4ChunkExtensionProvider;
import com.ibm.cos.v2.http.auth.aws.internal.signer.chunkedencoding.SigV4TrailerProvider;
import com.ibm.cos.v2.http.auth.aws.internal.signer.chunkedencoding.TrailerProvider;
import com.ibm.cos.v2.http.auth.aws.internal.signer.io.ChecksumInputStream;
import com.ibm.cos.v2.http.auth.aws.internal.signer.io.ResettableContentStreamProvider;
