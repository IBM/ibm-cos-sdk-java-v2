...
import com.ibm.cos.v2.auth.credentials.ProcessCredentialsProvider;
import com.ibm.cos.v2.auth.credentials.ProfileCredentialsProviderFactory;
import com.ibm.cos.v2.auth.credentials.ProfileProviderCredentialsContext;
...
import com.ibm.cos.v2.core.internal.util.ClassLoaderHelper;
...
import com.ibm.cos.v2.profiles.internal.ProfileSection;
...
public final class ProfileCredentialsUtils {
    private static final String STS_PROFILE_CREDENTIALS_PROVIDER_FACTORY =
        "com.ibm.cos.v2.services.sts.internal.StsProfileCredentialsProviderFactory";
    private static final String SSO_PROFILE_CREDENTIALS_PROVIDER_FACTORY =
        "com.ibm.cos.v2.services.sso.auth.SsoProfileCredentialsProviderFactory";
    ...
    private AwsCredentialsProvider roleAndCredentialSourceBasedProfileCredentialsProvider() {
        ...
        com.ibm.cos.v2.auth.credentials.internal.CredentialSourceType credentialSource = com.ibm.cos.v2.auth.credentials.internal.CredentialSourceType.parse(properties.get(ProfileProperty.CREDENTIAL_SOURCE));
