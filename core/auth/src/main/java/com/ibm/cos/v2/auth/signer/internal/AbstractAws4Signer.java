...
package com.ibm.cos.v2.auth.signer.internal;

import static com.ibm.cos.v2.auth.signer.Aws4UnsignedPayloadSigner.UNSIGNED_PAYLOAD;
...
import com.ibm.cos.v2.auth.signer.params.Aws4PresignerParams;
import com.ibm.cos.v2.auth.signer.params.Aws4SignerParams;
import com.ibm.cos.v2.auth.signer.params.SignerChecksumParams;
