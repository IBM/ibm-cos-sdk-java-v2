...
package com.ibm.cos.v2.auth.token.credentials;
 ...
 * provider via the 'com.ibm.cos.v2.services.ssooidc.internal.SsooidcTokenProviderFactory', assuming ssooidc is on the
 * classpath.
 */
@FunctionalInterface
@SdkProtectedApi
