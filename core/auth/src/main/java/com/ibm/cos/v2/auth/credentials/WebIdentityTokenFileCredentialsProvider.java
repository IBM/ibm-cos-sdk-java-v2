...
import com.ibm.cos.v2.auth.credentials.internal.WebIdentityCredentialsUtils;
import com.ibm.cos.v2.auth.credentials.internal.WebIdentityTokenCredentialProperties;
 ...
 * </ul>
 *
 * @see com.ibm.cos.v2.auth.credentials.AwsCredentialsProvider
 */
@SdkPublicApi
public class WebIdentityTokenFileCredentialsProvider
    implements com.ibm.cos.v2.auth.credentials.AwsCredentialsProvider, SdkAutoCloseable,
               ToCopyableBuilder<WebIdentityTokenFileCredentialsProvider.Builder, WebIdentityTokenFileCredentialsProvider> {

    private final com.ibm.cos.v2.auth.credentials.AwsCredentialsProvider credentialsProvider;
