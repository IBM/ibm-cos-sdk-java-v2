...
import com.ibm.cos.v2.auth.credentials.WebIdentityTokenCredentialsProviderFactory;
...
public final class WebIdentityCredentialsUtils {
    ...
    private static final String STS_WEB_IDENTITY_CREDENTIALS_PROVIDER_FACTORY =
        "com.ibm.cos.v2.services.sts.internal.StsWebIdentityCredentialsProviderFactory";
