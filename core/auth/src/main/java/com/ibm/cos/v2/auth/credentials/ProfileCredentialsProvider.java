...
import com.ibm.cos.v2.auth.credentials.internal.ProfileCredentialsUtils;
...
public final class ProfileCredentialsProvider
    implements com.ibm.cos.v2.auth.credentials.AwsCredentialsProvider,
               SdkAutoCloseable,
               ToCopyableBuilder<ProfileCredentialsProvider.Builder, ProfileCredentialsProvider> {

    private volatile com.ibm.cos.v2.auth.credentials.AwsCredentialsProvider credentialsProvider;
