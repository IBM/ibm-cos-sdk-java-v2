...
package com.ibm.cos.v2.auth.signer.params;
 ...
 * {@link com.ibm.cos.v2.http.auth.spi.signer.SignerProperty} and
 * {@link com.ibm.cos.v2.http.auth.spi.signer.HttpSigner} in 'http-auth-spi' instead.
 */
@Deprecated
@SdkPublicApi
