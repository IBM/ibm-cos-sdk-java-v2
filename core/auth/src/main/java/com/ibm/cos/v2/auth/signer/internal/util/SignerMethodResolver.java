...
package com.ibm.cos.v2.auth.signer.internal.util;

import static com.ibm.cos.v2.auth.signer.S3SignerExecutionAttribute.ENABLE_CHUNKED_ENCODING;
import static com.ibm.cos.v2.auth.signer.S3SignerExecutionAttribute.ENABLE_PAYLOAD_SIGNING;

import com.ibm.cos.v2.annotations.SdkInternalApi;
import com.ibm.cos.v2.auth.credentials.AwsCredentials;
//import com.ibm.cos.v2.auth.credentials.ibmOAuth.BasicIBMOAuthCredentials; TODO-REMOVE
import com.ibm.cos.v2.auth.signer.Aws4UnsignedPayloadSigner;
import com.ibm.cos.v2.auth.signer.AwsS3V4Signer;
...
public final class SignerMethodResolver {
    ...
    public static final String S3_SIGV4A_SIGNER_CLASS_PATH = "com.ibm.cos.v2.authcrt.signer.internal"
