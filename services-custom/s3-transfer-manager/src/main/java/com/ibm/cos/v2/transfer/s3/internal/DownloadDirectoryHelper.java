...
import static com.ibm.cos.v2.transfer.s3.internal.TransferConfigurationOption.DEFAULT_DELIMITER;
import static com.ibm.cos.v2.transfer.s3.internal.TransferConfigurationOption.DEFAULT_DIRECTORY_TRANSFER_MAX_CONCURRENCY;
import static com.ibm.cos.v2.transfer.s3.internal.TransferConfigurationOption.DEFAULT_PREFIX;
...
import com.ibm.cos.v2.transfer.s3.model.CompletedDirectoryDownload;
...
import com.ibm.cos.v2.transfer.s3.model.FailedFileDownload;
...
public class DownloadDirectoryHelper {
    ...
    private void doDownloadDirectory(CompletableFuture<CompletedDirectoryDownload> returnFuture,
        ...
        // Delimiter is null by default. See https://github.com/aws/ibm-cos-java-sdk/issues/1215
