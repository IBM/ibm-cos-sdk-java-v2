...
package com.ibm.cos.v2.transfer.s3;
...
import com.ibm.cos.v2.transfer.s3.internal.TransferManagerFactory;
...
import com.ibm.cos.v2.transfer.s3.progress.LoggingTransferListener;
 ...
 * to add {@code com.ibm.cos.v2.crt:aws-crt} dependency so that automatic multipart feature can be enabled</b>
 * {@snippet :
...
public interface S3TransferManager extends SdkAutoCloseable {
     ...
     * {#minimumPartSizeInBytes(Long)}. Note that for multipart copy request, existing metadata
     ...
     * {@code com.ibm.cos.v2.crt:aws-crt} is in the classpath. If AWS CRT is available, an AWS CRT-based S3 client will
