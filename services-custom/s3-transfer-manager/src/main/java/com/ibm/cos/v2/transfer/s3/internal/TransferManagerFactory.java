...
//import com.ibm.cos.v2.services.s3.internal.crt.S3CrtAsyncClient; TODO:REMOVE
...
public final class TransferManagerFactory {
    ...
    public static S3TransferManager createTransferManager(DefaultBuilder tmBuilder) {
        ...
        /*if (s3AsyncClient instanceof S3CrtAsyncClient) { TODO:REMOVE
            return new CrtS3TransferManager(transferConfiguration, s3AsyncClient, isDefaultS3AsyncClient);
        }*/

        if (!s3AsyncClient.getClass().getName().equals("com.ibm.cos.v2.services.s3.internal.multipart"
    ...
    private static boolean crtInClasspath() {
        try {
            ClassLoaderHelper.loadClass("com.ibm.cos.v2.crt.s3.S3Client", false);
