...
package com.ibm.cos.v2.release;

import static java.nio.charset.StandardCharsets.UTF_8;
import static com.ibm.cos.v2.release.CreateNewServiceModuleMain.computeInternalDependencies;
import static com.ibm.cos.v2.release.CreateNewServiceModuleMain.toList;
...
import com.ibm.cos.v2.utils.internal.CodegenNamingUtils;
 ...
 *     -Dexec.mainClass="com.ibm.cos.v2.release.NewServiceMain" \
...
public class NewServiceMain extends Cli {
    ...
    private static class NewServiceCreator {
        ...
        public void run() throws Exception {
            ...
            Path aggregatePomPath = mavenProjectRoot.resolve("ibm-cos-java-sdk").resolve("pom.xml");
