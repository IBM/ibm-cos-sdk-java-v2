...
public class ThreadFactoryBuilder {
    ...
    private String threadNamePrefix = "ibm-cos-java-sdk";
     ...
     *
     * For example, "ibm-cos-java-sdk-thread" could become "ibm-cos-java-sdk-thread-3-4".
     *
     * By default, this is "ibm-cos-java-sdk-thread".
     */
