...
import com.ibm.cos.v2.crt.CRT;
import com.ibm.cos.v2.crt.s3.S3Client;
import com.ibm.cos.v2.crt.s3.S3ClientOptions;
import com.ibm.cos.v2.crt.s3.S3FinishedResponseContext;
import com.ibm.cos.v2.crt.s3.S3MetaRequestResponseHandler;
import com.ibm.cos.v2.regions.Region;
import com.ibm.cos.v2.regions.providers.AwsRegionProvider;
import com.ibm.cos.v2.regions.providers.DefaultAwsRegionProviderChain;
import com.ibm.cos.v2.services.s3.internal.crt.S3NativeClientConfiguration;
...
public abstract class BaseCrtClientBenchmark implements  TransferManagerBenchmark {
    ...
    protected final com.ibm.cos.v2.services.s3.S3Client s3Sync;
    ...
    protected BaseCrtClientBenchmark(TransferManagerBenchmarkConfig config) {
        ...
        s3Sync = com.ibm.cos.v2.services.s3.S3Client.builder().build();
