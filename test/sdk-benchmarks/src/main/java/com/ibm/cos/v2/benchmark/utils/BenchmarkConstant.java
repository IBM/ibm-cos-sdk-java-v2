...
package com.ibm.cos.v2.benchmark.utils;
...
import com.ibm.cos.v2.services.protocolec2.model.AllTypesRequest;
...
public final class BenchmarkConstant {
    ...
    public static final com.ibm.cos.v2.services.protocolrestxml.model.AllTypesRequest XML_ALL_TYPES_REQUEST =
        com.ibm.cos.v2.services.protocolrestxml.model.AllTypesRequest.builder()
                                                                             .stringMember("foo")
                                                                             .integerMember(123)
                                                                             .booleanMember(true)
                                                                             .floatMember(123.0f)
                                                                             ...
                                                                             .blobArg(SdkBytes.fromUtf8String("hello "
                                                                                                              + "world"))
                                                                             .build();
    public static final com.ibm.cos.v2.services.protocolquery.model.AllTypesRequest QUERY_ALL_TYPES_REQUEST =
        com.ibm.cos.v2.services.protocolquery.model.AllTypesRequest.builder()
                                                                           .stringMember("foo")
                                                                           .integerMember(123)
                                                                           .booleanMember(true)
                                                                           .floatMember(123.0f)
    ...
    public static final com.ibm.cos.v2.services.protocolrestjson.model.AllTypesRequest JSON_ALL_TYPES_REQUEST =
        com.ibm.cos.v2.services.protocolrestjson.model.AllTypesRequest.builder()
                                                                              .stringMember("foo")
                                                                              .integerMember(123)
                                                                              .booleanMember(true)
                                                                              .floatMember(123.0f)
    ...
    public static final com.ibm.cos.v2.services.protocolsmithyrpcv2.model.AllTypesRequest RPCV2_ALL_TYPES_REQUEST =
        com.ibm.cos.v2.services.protocolsmithyrpcv2.model.AllTypesRequest.builder()
                                                                                 .stringMember("foo")
                                                                                 .integerMember(123)
                                                                                 .booleanMember(true)
                                                                                 .floatMember(123.0f)
