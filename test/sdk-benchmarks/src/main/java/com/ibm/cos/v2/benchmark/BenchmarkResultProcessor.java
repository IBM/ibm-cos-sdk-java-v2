...
import static com.ibm.cos.v2.benchmark.utils.BenchmarkUtils.compare;
...
import com.ibm.cos.v2.benchmark.stats.SdkBenchmarkParams;
import com.ibm.cos.v2.benchmark.stats.SdkBenchmarkResult;
import com.ibm.cos.v2.benchmark.stats.SdkBenchmarkStatistics;
...
class BenchmarkResultProcessor {
    ...
    private String getBenchmarkId(BenchmarkParams params) {
        return params.id().replaceFirst("com.ibm.cos.v2.benchmark.", "");
    }
