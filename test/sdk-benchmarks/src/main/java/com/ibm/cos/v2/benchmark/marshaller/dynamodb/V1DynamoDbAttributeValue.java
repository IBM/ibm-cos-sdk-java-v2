...
import com.ibm.cos.v2.AmazonWebServiceResponse;
import com.ibm.cos.v2.Request;
import com.ibm.cos.v2.http.HttpResponse;
import com.ibm.cos.v2.http.HttpResponseHandler;
import com.ibm.cos.v2.protocol.json.JsonClientMetadata;
import com.ibm.cos.v2.protocol.json.JsonOperationMetadata;
import com.ibm.cos.v2.protocol.json.SdkJsonProtocolFactory;
import com.ibm.cos.v2.services.dynamodbv2.model.AttributeValue;
import com.ibm.cos.v2.services.dynamodbv2.model.GetItemResult;
import com.ibm.cos.v2.services.dynamodbv2.model.PutItemRequest;
import com.ibm.cos.v2.services.dynamodbv2.model.transform.GetItemResultJsonUnmarshaller;
import com.ibm.cos.v2.services.dynamodbv2.model.transform.PutItemRequestProtocolMarshaller;
...
public class V1DynamoDbAttributeValue {
    ...
    private static SdkJsonProtocolFactory protocolFactory() {
        return new com.ibm.cos.v2.protocol.json.SdkJsonProtocolFactory(
