...
package com.ibm.cos.v2.testutils.service;
...
public class BlockHoundAllowlist implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        // https://github.com/aws/ibm-cos-java-sdk-v2/issues/2145
        builder.allowBlockingCallsInside(
            "com.ibm.cos.v2.http.nio.netty.internal.BetterSimpleChannelPool",
            "close"
        );

        // https://github.com/aws/ibm-cos-java-sdk-v2/issues/2360
        builder.allowBlockingCallsInside(
            "com.ibm.cos.v2.auth.credentials.InstanceProfileCredentialsProvider",
            "getToken"
        );
    }
}
